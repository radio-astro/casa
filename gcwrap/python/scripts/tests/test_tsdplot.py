...
from tsdplot import tsdplot
import asap as sd
from asap.scantable import is_scantable

class tsdplot_unittest_base:
    """
    Base class for tsdplot unit test
    """
    taskname = 'tsdplot'
...
#####
class tsdplot_errorTest( tsdplot_unittest_base, unittest.TestCase ):
    """
    ...
    #outfile = tsdplot_unittest_base.taskname + '_testErr.png'
    ...
    def test_overwrite( self ):
        ...
        res1 = tsdplot(infile=self.infile,outfile=self.outfile)
        self.assertEqual(res1,None)
        try:
            res2 = tsdplot(infile=self.infile,
    ...
    def test_badSelection( self ):
        ...
        spw = self.badid
        try:
            result = tsdplot(infile=self.infile,spw=spw)
            self.assertTrue(False,
                            msg='The task must throw exception')
        except Exception, err:
    ...
    def test_noTweight( self ):
        ...
        # this error is handled in task interface in tsdplot
        result = tsdplot(infile=self.infile,timeaverage=True,tweight='')
        self.assertFalse(result)

    def test_noPweight( self ):
        """test_noPweight: Polarization averaging without pweight"""
        # this error is handled in task interface in tsdplot
        result = tsdplot(infile=self.infile,polaverage=True,pweight='')
        self.assertFalse(result)
    ...
    def test_badLincat( self ):
        ...
        linecat = self.badstr
        try:
            result = tsdplot(infile=self.infile,plottype=type,linecat=linecat)
            self.assertTrue(False,
                            msg='The task must throw exception')
        except Exception, err:
    ...
    def test_badStack( self ):
        ...
        stack = " "
        try:
            result = tsdplot(infile=self.infile,plottype=type,stack=stack)
            self.assertTrue(False,
                            msg='The task must throw exception')
        except Exception, err:
...
#####
class tsdplot_basicTest( tsdplot_unittest_base, unittest.TestCase ):
    """
    ...
    # Input and output names
    infile = 'OrionS_rawACSmod_cal2123.asap'
    #figroot = tsdplot_unittest_base.taskname + '_test'
    figroot = 'tsdplot_test'
    figsuff = '.png'
    fig=None
    ...
    def testplot01( self ):
        ...
        plottype = 'azel'
        header = False
        result = tsdplot(infile=self.infile,plottype=plottype,header=header,
                        outfile=outfile)
        # Tests
    ...
    def testplot03( self ):
        ...
        plottype = 'totalpower'
        header = False
        result = tsdplot(infile=infile,plottype=plottype,header=header,
                        outfile=outfile)
    ...
    def testplot04( self ):
        ...
        spw = '0,2'
        header = False
        result = tsdplot(infile=infile,specunit=specunit,fluxunit=fluxunit,
    ...
    def testplot08( self ):
        ...
        stack = 'scan'
        header = False
        result = tsdplot(infile=infile,stack=stack,panel=panel,
                        header=header,outfile=outfile)
    ...
    def testplot13( self ):
        ...
        sprange = [3500,5000]
        header = False
        result = tsdplot(infile=infile,spw=spw,sprange=sprange,
                        header=header,outfile=outfile)
        locinfo = {'npanel': 1,'nstack': 2,
    ...
    def testplot14( self ):
        ...
        flrange = [0.,6.]
        header = False
        result = tsdplot(infile=infile,spw=spw,flrange=flrange,
                        header=header,outfile=outfile)
    ...
    def testplot20( self ):
        ...
        spw = '0,2'
        headsize = 11
        result = tsdplot(infile=infile,spw=spw,headsize=headsize,
                        outfile=outfile)
        # Tests
        self.assertEqual(result,None)
        currinfo = self._get_plot_info()
    ...
    def testplot21( self ):
        ...
        infile = self.infile
        spw = '0,2'
        result = tsdplot(infile=infile,spw=spw,
                        outfile=outfile)
        # Tests
        self.assertEqual(result,None)
        currinfo = self._get_plot_info()
    ...
    def testplot22( self ):
        ...
        header = False
        result = tsdplot(infile=infile,spw=spw,plotstyle=plotstyle,
    ...
    def testplot24( self ):
        ...
        panel = 'row'
        header = False
        result = tsdplot(infile=infile,panel=panel,
                        header=header,outfile=outfile)
    ...
    def testplot25( self ):
        ...
        stack = 'row'
        header = False
        result = tsdplot(infile=infile,stack=stack,
                        header=header,outfile=outfile)
    ...
    def testplot26( self ):
        ...
        stack = 'scan'
        header = False
        result = tsdplot(infile=infile,panel=panel,stack=stack,
                        header=header,outfile=outfile)
        self.assertEqual(result,None)
        self._checkOutFile(outfile,self.compare)
    ...
    def testplot29( self ):
        ...
        panel = 'i'
        header = False
        result = tsdplot(infile=infile,spw=spw,panel = panel,
...
#####
class tsdplot_storageTest( tsdplot_unittest_base, unittest.TestCase ):
    """
    Unit tests of task tsdplot. Test scantable sotrage and insitu
    parameters
    ...
    def testMT( self ):
        ...
        result = tsdplot(infile=self.infile,specunit=self.specunit,\
...
#####
class tsdplot_gridTest( tsdplot_unittest_base, unittest.TestCase ):
    """
    Unit tests of task tsdplot. Test plottype='grid'
    ...
    def testgrid01( self ):
        ...
        tid="01"
        outfile = self.figroot+tid+self.figsuff
        result = tsdplot(infile=self.infile, pol=self.pol,
...
#####
class tsdplot_selectTest( tsdplot_unittest_base, unittest.TestCase ):
    """
    ...
    def testsel01( self ):
        ...
        scan="23~25"
        panel = 's'
        result = tsdplot(infile=self.infile, scan=scan,
    ...
    def testsel03( self ):
        ...
        pol='>0'
        panel = 'p'
        result = tsdplot(infile=self.infile, pol=pol,
                        panel=panel, header=self.header,
                        outfile=outfile)
    ...
    def testsel04( self ):
        ...
        beam='<1'
        panel='b'
        result = tsdplot(infile=self.infile, beam=beam,
                        panel=panel, header=self.header,
                        outfile=outfile)
...
class tsdplot_selectionTest(selection_syntax.SelectionSyntaxTest,tsdplot_unittest_base,unittest.TestCase):
    """
    ...
    prefix=tsdplot_unittest_base.taskname+'TestSel'
    postfix='.plot.png'
    ...
    def test_scan_id_default(self):
        ...
        scan=''
        self.res=tsdplot(scan=scan,infile=self.infile,outfile=self.outfile)
...
#        self._compareDictVal(outinfo, refinfo)
    ...
    def test_spw_id_default(self):
        ...
        spw=''
        self.res=tsdplot(spw=spw,infile=self.infile,outfile=self.outfile)
        self.assertEqual(self.res,None, msg='Any error occurred during calibration')
        outinfo = self._get_plot_info()
        refinfo = self._set_plot_info(
            [1, 1, 2, 2, 1, 1],
    ...
    def test_beam_id_default(self):
        ...
        beam=''
        self.res=tsdplot(beam=beam,infile=self.infile,outfile=self.outfile)
        self.assertEqual(self.res,None, msg='Any error occurred during calibration')
        outinfo = self._get_plot_info()
        refinfo = self._set_plot_info(
            [1, 1, 2, 2, 1, 1],
...
def suite():
    return [tsdplot_basicTest, tsdplot_storageTest,tsdplot_gridTest,
            tsdplot_selectTest, tsdplot_errorTest,
            tsdplot_selectionTest]
