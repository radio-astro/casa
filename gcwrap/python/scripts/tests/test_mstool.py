...
class mstool_test_summary(mstool_test_base):
    ...
    def test_statistics2(self): 
        ...
        scan3stats = stats['SCAN_NUMBER=3,STATE_ID=-1,TIME=4304482365.000687']
        self.assertTrue(scan3stats['isMasked'])
        self.assertFalse(scan3stats['isWeighted'])
        self.assertEqual(scan3stats['minIndex'], 40785)
        self.assertEqual(scan3stats['maxIndex'], 2408)
