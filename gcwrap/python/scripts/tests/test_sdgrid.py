...
class sdgrid_map(sdgrid_unittest_base,unittest.TestCase):
    ...
    def test500(self):
        ...
        # pol0 must be 0.83333333333333337
        pol0=self.data[nonzeropix[0][0],nonzeropix[1][0]]
        self.check(0.83333333333333337,pol0)
        
        # pol1 must be 0.083333333333333329
        pol1=self.data[nonzeropix[0][1],nonzeropix[1][1]]
        self.check(0.083333333333333329,pol1)
    ...
    def test502(self):
        ...
        refdata=[  1.78139908e-05,   1.78139896e-06,   1.39832555e-04,
                   1.39832564e-05,   2.76656705e-04,   2.76656720e-05,
                   1.39832540e-04,   1.39832546e-05,   1.78139926e-05,
                   1.78139919e-06,   1.82159729e-05,   1.82159727e-06,
                   5.57767460e-04,   5.57767453e-05,   4.39381739e-03,
                   4.39381751e-04,   8.61705840e-03,   8.61705863e-04,
                   4.39381693e-03,   4.39381693e-04,   5.57767344e-04,
                   5.57767344e-05,   1.82159802e-05,   1.82159806e-06,
                   1.43026569e-04,   1.43026582e-05,   4.39495035e-03,
                   4.39495023e-04,   3.47487703e-02,   3.47487698e-03,
                   6.88703880e-02,   6.88703870e-03,   3.47487703e-02,
                   3.47487698e-03,   4.39494988e-03,   4.39494965e-04,
                   1.43026642e-04,   1.43026637e-05,   2.83210276e-04,
                   2.83210284e-05,   8.62627570e-03,   8.62627581e-04,
                   6.89262152e-02,   6.89262198e-03,   1.37739912e-01,
                   1.37739908e-02,   6.89262152e-02,   6.89262198e-03,
                   8.62627383e-03,   8.62627407e-04,   2.83210393e-04,
                   2.83210411e-05,   1.43030062e-04,   1.43030056e-05,
                   4.39505605e-03,   4.39505617e-04,   3.47496048e-02,
                   3.47496034e-03,   6.88720420e-02,   6.88720448e-03,
                   3.47496048e-02,   3.47496034e-03,   4.39505512e-03,
                   4.39505529e-04,   1.43030120e-04,   1.43030120e-05,
                   1.82443746e-05,   1.82443750e-06,   5.58637432e-04,
                   5.58637439e-05,   4.40066261e-03,   4.40066244e-04,
                   8.63050856e-03,   8.63050809e-04,   4.40066261e-03,
                   4.40066244e-04,   5.58637315e-04,   5.58637330e-05,
                   1.82443819e-05,   1.82443830e-06,   1.82802014e-05,
                   1.82802012e-06,   1.43483907e-04,   1.43483912e-05,
                   2.83886126e-04,   2.83886129e-05,   1.43483907e-04,
                   1.43483912e-05,   1.82801978e-05,   1.82801978e-06  ]
        nonzerodata=numpy.take(self.data,nonzeropix[1],axis=1).squeeze()
        for i in xrange(len(nonzerodata)):
            self.check(refdata[i],nonzerodata[i])
