...
public:
	...
	/**
	 * Get all rows.
	 * @return Alls rows as a vector of pointers of PolarizationRow. The elements of this vector are stored in the order 
	 * in which they have been added to the PolarizationTable.
	 */
	vector<PolarizationRow *> get() ;
...
private:
	...
	void autoIncrement(string key, PolarizationRow* x);
...
// In all cases we maintain a private vector of PolarizationRow s.
   vector<PolarizationRow * > privateRows;
   

			
	vector<PolarizationRow *> row;
