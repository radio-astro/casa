...
class MakeCleanListQAHandler(pqa.QAResultHandler):    
    result_cls = resultobjects.MakeCleanListResult
    child_cls = None
...
class MakeCleanListListQAHandler(pqa.QAResultHandler):
    result_cls = list
    child_cls = resultobjects.MakeCleanListResult
