...
int main() {
    try {
    	...
    	// 2, 5, 6, 6, 7, 10, 11
    	{
    		...
    		AlwaysAssert(r.asuInt("maxDatasetIndex") == 0, AipsError);
    		AlwaysAssert(r.asInt64("maxIndex") == 7, AipsError);
    		AlwaysAssert(r.asDouble("mean") == eSum/eNpts, AipsError);
    		AlwaysAssert(r.asDouble("min") == 2, AipsError);
    		AlwaysAssert(r.asuInt("minDatasetIndex") == 0, AipsError);
    		AlwaysAssert(r.asInt64("minIndex") == 1, AipsError);
    		AlwaysAssert(r.asDouble("npts") == eNpts, AipsError);
    		AlwaysAssert(r.asDouble("rms") == sqrt(eSumSq/eNpts), AipsError);
    		AlwaysAssert(r.asDouble("stddev") == sqrt(eVar), AipsError);
    		AlwaysAssert(r.asDouble("sum") == eSum, AipsError);
    		AlwaysAssert(r.asDouble("sumsq") == eSumSq, AipsError);
