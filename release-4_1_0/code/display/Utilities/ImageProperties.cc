...
namespace casa {
	...
	ImageProperties::ImageProperties( ImageInterface<Float> *image ) { reset(image); }
	...
	static bool beam_compare( const GaussianBeam &a, const GaussianBeam &b ) { return a.getArea("rad2") < b.getArea("rad2"); }
