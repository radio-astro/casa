...
\date{07 February 2013, (last modified : 26 March 2013)}
\maketitle

This memo describes the MSTransform module in CASA as available from version 4.1 onwards. 
Section \ref{Sec:CodeDocs} gives an outline of the software implementation. Section \ref{Sec:Running} 
describes what 
