...
$(document).ready(function () {
    ...
    filterPipeline.addFilter(FILTERS.createMatchFilter('intent', '#select-intent'));
...
<div class="column-fluid">
	<div class="row-fluid">
		...
		<div class="column-fluid span6">
			<div>
			<fieldset>
				<legend>Intent Filter</legend>
				<select id="select-intent" class="select2" multiple style="width:100%" placeholder="Show all intents">
					% for intent in sorted(list(set([p.parameters['intent'] for p in plots]))):
		...
		<li class="span2">
			<div class="thumbnail">
				<a class="fancybox"
				   ...
				   title="Spw ${plot.parameters['spw']} ${plot.parameters['intent']}"
