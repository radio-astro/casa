...
<div class="column-fluid">
    ...
    <div class="row-fluid">
        <div class="column-fluid span6">
            <div>
            <fieldset>
                <legend>Polarization Filter</legend>
		...
		<li class="span2">
			<div class="thumbnail">
				<a class="fancybox"
				   ...
				   title="Antenna ${plot.parameters['ant']} spw ${plot.parameters['spw']} pol ${plot.parameters['pol']}"
				   data-thumbnail="${os.path.relpath(plot.thumbnail, pcontext.report_dir)}">
					...
					<p class="text-center">Antenna ${plot.parameters['ant']} spw ${plot.parameters['spw']} pol ${plot.parameters['pol']}</p>
			</div>
		</li>
	% endfor
	</ul>
