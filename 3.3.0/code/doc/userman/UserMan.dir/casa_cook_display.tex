...
% MK: the LEL box is no longer there...
%You can also enter a 'Lattice Expression Language' (LEL) expression in the box provided
...
\begin{figure}[h!]
\begin{center}
% MK:this is now two images 
\pngname{viewer_n5921_contour_moments_1}{6}
\pngname{viewer_n5921_contour_moments_2}{6}
\caption{\label{fig:viewer_rascon} The {\bf Viewer Display Panel}
(left) and {\bf Data Display Options} panel (right) after overlaying
...
Then open one of the following  pop-up windows via the {\tt Tools}
menu: 
