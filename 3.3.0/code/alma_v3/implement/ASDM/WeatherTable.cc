 ...
 */
	...
	string WeatherTable::toXML()  {
		...
		buf.append("<WeatherTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:weathr=\"http://Alma/XASDM/WeatherTable\" xsi:schemaLocation=\"http://Alma/XASDM/WeatherTable http://almaobservatory.org/XML/XASDM/3/WeatherTable.xsd\" schemaVersion=\"3\" schemaRevision=\"1.60\">\n");
	...
	string WeatherTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<WeatherTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:weathr=\"http://Alma/XASDM/WeatherTable\" xsi:schemaLocation=\"http://Alma/XASDM/WeatherTable http://almaobservatory.org/XML/XASDM/3/WeatherTable.xsd\" schemaVersion=\"3\" schemaRevision=\"1.60\">\n";
