...
namespace asdm {
	...
	const vector<string> CalDelayTable::attributesNames = initAttributesNames();
 ...
 */
	 ...
	 */
	vector<string> CalDelayTable::initAttributesNames() {
		...
		attributesNames.push_back("delayError");
		...
		attributesNames.push_back("appliedDelay");


		attributesNames.push_back("crossDelayOffset");

		attributesNames.push_back("crossDelayOffsetError");

		attributesNames.push_back("numSideband");

		attributesNames.push_back("refFreq");

		attributesNames.push_back("refFreqPhase");

		attributesNames.push_back("sidebands");
	 ...
	 */
	const vector<string>& CalDelayTable::getAttributesNames() { return attributesNames; }
...
CalDelayRow* CalDelayTable::lookup(string antennaName, AtmPhaseCorrectionMod::AtmPhaseCorrection atmPhaseCorrection, BasebandNameMod::BasebandName basebandName, ReceiverBandMod::ReceiverBand receiverBand, Tag calDataId, Tag calReductionId, ArrayTime startValidTime, ArrayTime endValidTime, string refAntennaName, int numReceptor, vector<double > delayError, vector<double > delayOffset, vector<PolarizationTypeMod::PolarizationType > polarizationTypes, vector<double > reducedChiSquared, vector<double > appliedDelay) {
	...
	string CalDelayTable::toXML()  {
		...
		buf.append("<CalDelayTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:cldly=\"http://Alma/XASDM/CalDelayTable\" xsi:schemaLocation=\"http://Alma/XASDM/CalDelayTable http://almaobservatory.org/XML/XASDM/3/CalDelayTable.xsd\" schemaVersion=\"3\" schemaRevision=\"1.60\">\n");
	...
	string CalDelayTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<CalDelayTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:cldly=\"http://Alma/XASDM/CalDelayTable\" xsi:schemaLocation=\"http://Alma/XASDM/CalDelayTable http://almaobservatory.org/XML/XASDM/3/CalDelayTable.xsd\" schemaVersion=\"3\" schemaRevision=\"1.60\">\n";
