...
% if azel_plot:
	<div class="col-md-6">
		<a href="${os.path.relpath(azel_plot.abspath, pcontext.report_dir)}" class="fancybox">
...
% if el_vs_time_plot:
	<div class="col-md-6">
		<a href="${os.path.relpath(el_vs_time_plot.abspath, pcontext.report_dir)}" class="fancybox">
