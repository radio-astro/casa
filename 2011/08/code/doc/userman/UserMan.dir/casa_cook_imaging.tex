...
specify {\tt nchan} and {\tt start} to get what you want. For best
results, we also recommend {\tt 'nearest'} interpolation for the {\tt mode=channel}. 
...
products, or linear polarizatin products (X/Y). 
For example,
\small
\begin{verbatim}
