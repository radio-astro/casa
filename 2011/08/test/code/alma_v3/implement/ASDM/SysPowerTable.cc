...
namespace asdm {
	...
	string SysPowerTable::tableName = "SysPower";
	const vector<string> SysPowerTable::attributesNames = initAttributesNames();
 ...
 */
	 ...
	 */
	vector<string> SysPowerTable::initAttributesNames() {
 ...
 */
	...
	string SysPowerTable::toXML()  {
		...
		buf.append("<SysPowerTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:syspwr=\"http://Alma/XASDM/SysPowerTable\" xsi:schemaLocation=\"http://Alma/XASDM/SysPowerTable http://almaobservatory.org/XML/XASDM/3/SysPowerTable.xsd\" schemaVersion=\"3\" schemaRevision=\"1.60\">\n");
	...
	string SysPowerTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<SysPowerTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:syspwr=\"http://Alma/XASDM/SysPowerTable\" xsi:schemaLocation=\"http://Alma/XASDM/SysPowerTable http://almaobservatory.org/XML/XASDM/3/SysPowerTable.xsd\" schemaVersion=\"3\" schemaRevision=\"1.60\">\n";
