...
public:
    ...
    static CoordinateSystem defaultCoordinateSystem() { return Physical; }
    ...
    static QString coordinateSystem(CoordinateSystem c) {
        switch(c) {
        case Physical: return FILE_PHYSICAL;
        case Image: return FILE_IMAGE;
        case FK4: return FILE_FK4;
        case FK5: return FILE_FK5;
        case Galactic: return FILE_GALACTIC;
        case Ecliptic: return FILE_ECLIPTIC;
        case Linear: return FILE_LINEAR;
        case Amplifier: return FILE_AMPLIFIER;
        case Detector: return FILE_DETECTOR;
    ...
    static QString regionType(RegionType type) {
        switch(type) {
        case Circle:                      return FILE_CIRCLE;
        case Annulus:                     return FILE_ANNULUS;
        case Ellipse: case EllipseAnnulus:return FILE_ELLIPSE;
        case Box: case BoxAnnulus:        return FILE_BOX;
        case Polygon:                     return FILE_POLYGON;
        case Line:                        return FILE_LINE;
        case Vector:                      return FILE_VECTOR;
        case Text:                        return FILE_TEXT;
        case Ruler:                       return FILE_RULER;
        case CirclePoint:                return FILE_CIRCLE + " " + FILE_POINT;
        case BoxPoint:                    return FILE_BOX + " " + FILE_POINT;
        case DiamondPoint:              return FILE_DIAMOND + " " + FILE_POINT;
        case CrossPoint:                  return FILE_CROSS + " " + FILE_POINT;
        case XPoint:                      return FILE_X + " " + FILE_POINT;
        case ArrowPoint:                  return FILE_ARROW + " " + FILE_POINT;
        case BoxCirclePoint:            return FILE_BOXCIRCLE+ " " +FILE_POINT;
        case Compass:                     return FILE_COMPASS;
        case Projection:                  return FILE_PROJECTION;
        case Panda:                       return FILE_PANDA;
        case EllipticalPanda:             return FILE_EPANDA;
        case BoxPanda:                    return FILE_BPANDA;
        case Composite:                   return FILE_COMPOSITE;
    ...
    static QString pointType(RegionType type) {
        switch(type) {
        case CirclePoint:    return FILE_CIRCLE;
        case BoxPoint:       return FILE_BOX;
        case DiamondPoint:   return FILE_DIAMOND;
        case CrossPoint:     return FILE_CROSS;
        case XPoint:         return FILE_X;
        case ArrowPoint:     return FILE_ARROW;
        case BoxCirclePoint: return FILE_BOXCIRCLE;
...
public:
    ...
    static vector<String> properties() {
        ...
        v[0] = PROP_INCLUDE;         v[1] = PROP_TEXT;
        v[2] = PROP_COLOR;           v[3] = PROP_FONT;
        v[4] = PROP_SELECT;          v[5] = PROP_EDIT;
        v[6] = PROP_MOVE;            v[7] = PROP_ROTATE;
        v[8] = PROP_DELETE;          v[9] = PROP_FIXED;
        v[10] = PROP_LINE;           v[11] = PROP_RULER;
        v[12] = PROP_SOURCE;         v[13] = PROP_BACKGROUND;
        v[14] = PROP_TEXTANGLE;      v[15] = PROP_WIDTH;
        v[16] = PROP_MARKER_SIZE;    v[17] = PROP_HIGHLITE;
        v[18] = PROP_TAG;            v[19] = PROP_VECTOR;
        v[20] = PROP_COMPASS;        v[21] = PROP_COMPASS_NLABEL;
        v[22] = PROP_COMPASS_ELABEL; v[23] = PROP_COMPOSITE;
        v[24] = PROP_DASH;           v[25] = PROP_DASHLIST;
        return v;
    }
