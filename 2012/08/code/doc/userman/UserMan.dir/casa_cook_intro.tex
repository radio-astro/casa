...
\begin{itemize}
    \item Linux
      \begin{itemize}
          \item RedHat 5.5 (32-bit \& 64-bit)
          \item Fedora 14 (64-bit)
          \item Ubuntu 10.10 (64-bit) 
      \end{itemize}
...
\item {\bf  Flagging}
  \begin{itemize}
   ...
   \item  The flagversions names have changed as requested. The backup names do not take a mode as part of their names anymore. They only take the task name along with an index. Example: {\it flags.tflagdata\_1} or {\it flags.flagcmd\_1}.
...
\begin{itemize}
  ...
  \item  calibration tables are now independent from the original MS
   ...
   \item  frequency interpolation of calibration tables
  ...
  \item  {\tt uvcontsub} supports fitorders > 1 for continuum subtraction
...
\begin{itemize}
  \item  unified, optimized visibility access
