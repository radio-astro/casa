...
public:
	 ...
	 */	
	void fromIDL(SquareLawDetectorTableIDL x) throw(DuplicateKey,ConversionException);
#endif
...
private:
	 ...
	 */
	SquareLawDetectorRow* checkAndAdd(SquareLawDetectorRow* x) throw (DuplicateKey, UniquenessViolationException);
