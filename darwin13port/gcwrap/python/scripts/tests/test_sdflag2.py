...
class sdflag2_test(unittest.TestCase):
    ...
    ***NOTE*** These tests are for Scantable only. Tests for the other formats
    ...
    def test00(self):
        ...
        #flag
        result = sdflag2(infile=infile, mode=mode, maskflag=maskflag)
    ...
    def test01(self):
        ...
        #flag
        result = sdflag2(infile=infile, mode=mode, rows=flagrow)
    ...
    def test02(self):
        ...
        #flag
        result = sdflag2(infile=infile, mode=mode, clipminmax=clipminmax)
    ...
    def test03(self):
        ...
        mode = 'manual'
        try:
            result = sdflag2(infile=infile, mode=mode, ifs=iflist,
                             maskflag=maskflag)
        except Exception, e:
