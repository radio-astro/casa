 ...
 *
 * "@(#) $Id: ATMRefractiveIndexProfile.h,v 1.12 2011/11/22 18:08:04 jroche Exp $"
 *
 * who       when      what
 * --------  --------  ----------------------------------------------
...
public:
  ...
  inline void addNewSpectralWindow(vector<Frequency> chanFreq)
  {
   ...
   */
  inline double getFrequency(const string &freqUnits)
  {
  ...
  InverseLength getAbsH2OLines(unsigned int nl)
  {
  ...
  InverseLength getAbsH2OLines(unsigned int nf, unsigned int nl)
  {
  ...
  InverseLength getAbsH2OCont(unsigned int nl)
  {
  ...
  InverseLength getAbsH2OCont(unsigned int nf, unsigned int nl)
  {
  ...
  InverseLength getAbsO2Lines(unsigned int nl)
  {
  ...
  InverseLength getAbsO2Lines(unsigned int nf, unsigned int nl)
  {
  ...
  InverseLength getAbsDryCont(unsigned int nl)
  {
  ...
  InverseLength getAbsDryCont(unsigned int nf, unsigned int nl)
  {
  ...
  InverseLength getAbsO3Lines(unsigned int nl)
  {
  ...
  InverseLength getAbsO3Lines(unsigned int nf, unsigned int nl)
  {
  ...
  InverseLength getAbsCOLines(unsigned int nl)
  {
  ...
  InverseLength getAbsCOLines(unsigned int nf, unsigned int nl)
  {
  ...
  InverseLength getAbsN2OLines(unsigned int nl)
  {
  ...
  InverseLength getAbsN2OLines(unsigned int nf, unsigned int nl)
  {
  ...
  InverseLength getAbsNO2Lines(unsigned int nl)
  {
  ...
  InverseLength getAbsNO2Lines(unsigned int nf, unsigned int nl)
  {
  ...
  InverseLength getAbsSO2Lines(unsigned int nl)
  {
  ...
  InverseLength getAbsSO2Lines(unsigned int nf, unsigned int nl)
  {
  ...
  InverseLength getAbsTotalDry(unsigned int nl)
  {
  ...
  InverseLength getAbsTotalDry(unsigned int nf, unsigned int nl)
  {
  ...
  InverseLength getAbsTotalWet(unsigned int nl)
  {
  ...
  InverseLength getAbsTotalWet(unsigned int nf, unsigned int nl)
  {
...
protected:
  ...
  vector<vector<complex<double> >*> vv_N_NO2LinesPtr_; //!< NO2 lines absorption coefficient and delay term  (rad m^-1,m^-1)
  vector<vector<complex<double> >*> vv_N_SO2LinesPtr_; //!< SO2 lines absorption coefficient and delay term  (rad m^-1,m^-1)
  ...
  bool updateRefractiveIndexProfile(Length altitude,
                                    Pressure groundPressure,
                                    Temperature groundTemperature,
                                    double tropoLapseRate,
                                    Humidity relativeHumidity,
