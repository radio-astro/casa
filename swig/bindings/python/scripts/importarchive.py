...
def importarchive(archivefiles=None,vis=None,bandname=None,freqtol=None):
	...
	fg=myf['fg']
        ...
        function_signature_defaults=dict(zip(importarchive.func_code.co_varnames,importarchive.func_defaults))
	...
	try:
		...
		parameter_checkmenu('bandname',bandname,['4','P','L','C','X','U','K','Q'])
	except TypeError, e:
	...
	try:
		for archivefile in archivefiles:
			...
			vlafiller(msname=vis,inputfile=archivefile,overwrite=overwrite,
			bandname=bandname,freqtol=freqtol)
			i=i+1
