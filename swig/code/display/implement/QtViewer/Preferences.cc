...
namespace casa {
	...
	const char *Preferences::init_state[] = { 
	  ...
	  "viewer.iclean.position.animator", "L", "right", "in which dock (left, right, top, bottom) should the animator be shown", "L/R/T/B",
	  "viewer.iclean.position.cursor_tracking", "L", "right", "in which dock (left, right, top, bottom) should the cursor tracking be shown", "L/R/T/B",
	...
	void Preferences::init( ) {
	    ...
	    /*int rc_count = */ tokenize(tokenized);
