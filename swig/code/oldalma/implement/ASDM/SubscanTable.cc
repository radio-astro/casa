 ...
 */
     ...
     */
	SubscanRow* SubscanTable::newRow(Tag execBlockId, int scanNumber, int subscanNumber, ArrayTime startTime, ArrayTime endTime, SubscanIntentMod::SubscanIntent subscanIntent, int numberIntegration, vector<int > numberSubintegration, bool flagRow, string fieldName){
	...
	SubscanRow* SubscanTable::newRowFull(Tag execBlockId, int scanNumber, int subscanNumber, ArrayTime startTime, ArrayTime endTime, SubscanIntentMod::SubscanIntent subscanIntent, int numberIntegration, vector<int > numberSubintegration, bool flagRow, string fieldName)	{
		SubscanRow *row = new SubscanRow(*this);
...
SubscanRow* SubscanTable::newRowCopy(SubscanRow* row) {
	 ...
	 */
	SubscanRow*  SubscanTable::checkAndAdd(SubscanRow* x) throw (DuplicateKey) {
 ...
 */
SubscanRow* SubscanTable::lookup(Tag execBlockId, int scanNumber, int subscanNumber, ArrayTime startTime, ArrayTime endTime, SubscanIntentMod::SubscanIntent subscanIntent, int numberIntegration, vector<int > numberSubintegration, bool flagRow, string fieldName) {
		SubscanRow* aRow;
		for (unsigned int i = 0; i < size(); i++) {
			aRow = row.at(i); 
			if (aRow->compareNoAutoInc(execBlockId, scanNumber, subscanNumber, startTime, endTime, subscanIntent, numberIntegration, numberSubintegration, flagRow, fieldName)) return aRow;
		}			
		return 0;	
} 
...
#ifndef WITHOUT_ACS
	void SubscanTable::fromIDL(SubscanTableIDL x) throw(DuplicateKey,ConversionException) {
	...
	char *SubscanTable::toFITS() const throw(ConversionException) {
		throw ConversionException("Not implemented","Subscan");
	}

	void SubscanTable::fromFITS(char *fits) throw(ConversionException) {
		throw ConversionException("Not implemented","Subscan");
	}

	string SubscanTable::toVOTable() const throw(ConversionException) {
		throw ConversionException("Not implemented","Subscan");
	}

	void SubscanTable::fromVOTable(string vo) throw(ConversionException) {
		throw ConversionException("Not implemented","Subscan");
	}

	string SubscanTable::toXML()  throw(ConversionException) {
		string buf;
		buf.append("<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?> ");
//		buf.append("<SubscanTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:noNamespaceSchemaLocation=\"../../idl/SubscanTable.xsd\"> ");
	...
	void SubscanTable::fromXML(string xmlDoc) throw(ConversionException) {
		Parser xml(xmlDoc);
	...
	void SubscanTable::error() throw(ConversionException) {
