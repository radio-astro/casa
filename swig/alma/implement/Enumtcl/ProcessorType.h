...
template<>
 struct enum_set_traits<ProcessorType> : public enum_set_traiter<ProcessorType,3,ProcessorTypeMod::SPECTROMETER> {};

template<>
class enum_map_traits<ProcessorType,void> : public enum_map_traiter<ProcessorType,void> {
public:
  static bool   init_;
