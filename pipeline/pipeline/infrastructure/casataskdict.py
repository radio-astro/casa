...
TASK_COMMENTS = {
    ...
    (hifa_tasks.ALMAAgentFlagger,): (
        ...
        'process, and manually input by the pipeline user.'
    ),
    (hifa_tasks.FluxcalFlag,) : (
        SILENT_TASK_COMMENT
    ),
    (hif_tasks.RefAnt,) : (
        'The pipeline prioritizes antennas based on fraction flagged and '
        'position in the array. The best antenna is used as a reference '
