...
class CalibrationTopic(Topic):
    ...
    """    
    def __init__(self):
        super(CalibrationTopic, self).__init__('t2-3-1m.html', 'Calibration')
...
class LineFindingTopic(Topic):
    ...
    """
    def __init__(self):
        super(LineFindingTopic, self).__init__('t2-3-2m.html', 'Line Finding')
...
class ImagingTopic(Topic):
    ...
    """
    def __init__(self):
        super(ImagingTopic, self).__init__('t2-3-4m.html', 'Imaging')
...
class MiscellaneousTopic(Topic):
    ...
    """
    def __init__(self):
        super(MiscellaneousTopic, self).__init__('t2-3-5m.html', 'Miscellaneous')


class TopicRegistry(object):
    # holds the Topics into which we should push the results 
    topic_classes = [CalibrationTopic,
                     FlaggingTopic,
                     LineFindingTopic,
                     ImagingTopic,
                     MiscellaneousTopic]
