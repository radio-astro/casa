...
import task_hifa_session_bandpass
def hifa_session_bandpass(vis=[''], caltable=[''], field='', intent='', spw='', antenna='', hm_phaseup='snr', phaseupsolint='int', phaseupbw='', phaseupsnr=20.0, phaseupnsols=2, hm_bandpass='snr', solint='inf', maxchannels=240, evenbpints=True, bpsnr=50.0, bpnsols=8, hm_bandtype='channel', combine='scan', refant='', solnorm=True, minblperant=4, minsnr=3.0, degamp='', degphase='', pipelinemode='automatic', dryrun=False, acceptresults=True, parallel='automatic'):
...
#
	...
	trec = casac.utils().torecord(pathname+'hifa_session_bandpass.xml')

        casalog.origin('hifa_session_bandpass')
        if trec.has_key('hifa_session_bandpass') and casac.utils().verify(mytmp, trec['hifa_session_bandpass']) :
	    result = task_hifa_session_bandpass.hifa_session_bandpass(vis, caltable, field, intent, spw, antenna, hm_phaseup, phaseupsolint, phaseupbw, phaseupsnr, phaseupnsols, hm_bandpass, solint, maxchannels, evenbpints, bpsnr, bpnsols, hm_bandtype, combine, refant, solnorm, minblperant, minsnr, degamp, degphase, pipelinemode, dryrun, acceptresults, parallel)
