...
def hifv_circfeedpolcal(vis=[''], pipelinemode='automatic', dryrun=False, acceptresults=True):
...
#
	...
	trec = casac.utils().torecord(pathname+'hifv_circfeedpolcal.xml')
	    ...
	    result = task_hifv_circfeedpolcal.hifv_circfeedpolcal(vis, pipelinemode, dryrun, acceptresults)
