...
$(document).ready(function () {
    ...
    // to highlight
    var charts = [ALL_IN_ONE.easyHistogram(filterPipeline, scores_dict, "PHASE_SCORE_DD", "#histogram-dd", xAxis),
    			  ALL_IN_ONE.easyHistogram(filterPipeline, scores_dict, "PHASE_SCORE_FN", "#histogram-fn", xAxis),
				  ALL_IN_ONE.easyHistogram(filterPipeline, scores_dict, "PHASE_SCORE_RMS", "#histogram-rms", xAxis)]
...
<div class="page-header">
	<h1>Bandpass phase for ${vis}<button class="btn btn-large pull-right" onClick="javascript:location.reload();">Back</button></h1>
</div>
...
<div class="column-fluid">
	...
	<div class="row-fluid">
		...
		<div class="column-fluid span4">
			<fieldset>
				<legend>RMS (0.05 rad, Error Fn)</legend>
				<div id="histogram-rms"  class="span12">
			</fieldset>
		</div>
                -->
		<div class="column-fluid span4">
