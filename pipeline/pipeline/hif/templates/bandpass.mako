		...
		<li class="span8">
			<div class="thumbnail">
				<div class="caption">
	                ...
	                below to show plots with specific antennas preselected.  
					</p>
				</div>		
				<div class="row-fluid">
			        <% 
					...
					<div class="span6">
						...
						<div class="caption">
							<h5>
				                Typical antenna (${plot.parameters['ant']})
			                    (<a href="${os.path.relpath(os.path.join(dirname, amp_subpages[ms]), pcontext.report_dir)}"
			                       class="replace"
			                       data-ant="${plot.parameters['ant']}">
			                       show ${plot.parameters['ant']}
			...
			<div class="thumbnail">
				<div class="caption">
					<h4>Phase vs frequency 
						(<a class="replace"
				           href="${os.path.relpath(os.path.join(dirname, phase_subpages[ms]), pcontext.report_dir)}">
            			show all
        				</a>)
					</h4>
	                ...
	                link for just the reference antenna.
					</p>
				</div>		
				<div class="row-fluid">
			        <% 
