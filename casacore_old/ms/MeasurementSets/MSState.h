//# MSState.h: The MeasurementSet STATE Table
...
//#
//#
//# $Id: MSState.h 21521 2014-12-10 08:06:42Z gervandiepen $
...
//
// <etymology>
// MSState stands for the MeasurementSet State table.
// </etymology>
//
// <synopsis> 
// An MSState is a table intended to hold the STATE table for
...
public:
    ...
    // on validity (verifying that the MSState will have the required columns
    // and keywords).
    // An exception is thrown if the constructed Table is not a valid MSState
    // <thrown>
    //   <li> AipsError
    // </thrown>
    ...
    MSState referenceCopy(const String& newTableName,
