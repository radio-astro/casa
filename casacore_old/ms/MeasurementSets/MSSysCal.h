//# MSSysCal.h: The MeasurementSet SYSCAL Table
...
//#
//#
//# $Id: MSSysCal.h 21521 2014-12-10 08:06:42Z gervandiepen $
...
//
// <synopsis> 
// An MSSysCal is a table intended to hold the SYSCAL table for
...
public:
    ...
    // on validity (verifying that the MSSysCal will have the required columns
    // and keywords)
    // An exception is thrown if the constructed Table is not a valid MSSysCal
    // <thrown>
    //   <li> AipsError
    // </thrown>
    ...
    MSSysCal referenceCopy(const String& newTableName,
