...
class NRODataset
{
 public:
  ...
  int getARYNM() const { return ARYNM ; } ;
  int getNSCAN() const { return NSCAN ; } ;
  const std::string getTITLE() const { return TITLE ; } ;
  const std::string getOBJ() const { return OBJ ; } ;
  const std::string getEPOCH() const { return EPOCH ; } ;
  double getRA0() const { return RA0 ; } ;
  double getDEC0() const { return DEC0 ; } ;
  double getGLNG0() const { return GLNG0 ; } ;
  double getGLAT0() const { return GLAT0 ; } ;
  int getNCALB() const { return NCALB ; } ;
  int getSCNCD() const { return SCNCD ; } ;
  const std::string getSCMOD() const { return SCMOD ; } ;
  double getURVEL() const { return URVEL ; } ;
  ...
  double getFRQSW() const { return FRQSW ; } ;
  double getDBEAM() const { return DBEAM ; } ;
  double getMLTOF() const { return MLTOF ; } ;
  double getCMTQ() const { return CMTQ ; } ;
  double getCMTE() const { return CMTE ; } ;
  double getCMTSOM() const { return CMTSOM ; } ;
  double getCMTNODE() const { return CMTNODE ; } ;
  double getCMTI() const { return CMTI ; } ;
  const std::string getCMTTM() const { return CMTTM ; } ;
  double getSBDX() const { return SBDX ; } ;
  double getSBDY() const { return SBDY ; } ;
  double getSBDZ1() const { return SBDZ1 ; } ;
  double getSBDZ2() const { return SBDZ2 ; } ;
  double getDAZP() const { return DAZP ; } ;
  double getDELP() const { return DELP ; } ;
  int getCHBIND() const { return CHBIND ; } ;
  int getNUMCH() const { return NUMCH ; } ;
  int getCHMIN() const { return CHMIN ; } ;
  int getCHMAX() const { return CHMAX ; } ;
  double getALCTM() const { return ALCTM ; } ;
  double getIPTIM() const { return IPTIM ; } ;
  double getPA() const { return PA ; } ;
  int getSCNLEN() const { return SCNLEN ; } ;
  int getSBIND() const { return SBIND ; } ;
  int getIBIT() const { return IBIT ; } ;
