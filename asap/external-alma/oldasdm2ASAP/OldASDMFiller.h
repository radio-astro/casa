#ifndef ASAP_OLD_ASDM_FILLER_H
#define ASAP_OLD_ASDM_FILLER_H
...
class OldASDMFiller : public asap::FillerBase
{
public:
  // constructor and destructor
  OldASDMFiller( casa::CountedPtr<asap::Scantable> stable ) ;
  ~OldASDMFiller() ;
  ...
  // get reader object
  casa::CountedPtr<OldASDMReader> getReader() { return reader_ ; } ;
...
private:
  ...
  casa::CountedPtr<OldASDMReader> reader_ ;
  casa::Int antennaId_ ;
