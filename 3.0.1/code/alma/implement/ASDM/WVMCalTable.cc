 ...
 */
	...
	string WVMCalTable::toXML()  {
		...
		buf.append("<WVMCalTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:wvmcl=\"http://Alma/XASDM/WVMCalTable\" xsi:schemaLocation=\"http://Alma/XASDM/WVMCalTable http://almaobservatory.org/XML/XASDM/2/WVMCalTable.xsd\" schemaVersion=\"2\" schemaRevision=\"1.53\">\n");
	...
	string WVMCalTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<WVMCalTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:wvmcl=\"http://Alma/XASDM/WVMCalTable\" xsi:schemaLocation=\"http://Alma/XASDM/WVMCalTable http://almaobservatory.org/XML/XASDM/2/WVMCalTable.xsd\" schemaVersion=\"2\" schemaRevision=\"1.53\">\n";
   ...
   //
    ...
    if (boost::filesystem::exists(boost::filesystem::path(directory + "/WVMCal.xml")))
      setFromXMLFile(directory);
    else if (boost::filesystem::exists(boost::filesystem::path(directory + "/WVMCal.bin")))
