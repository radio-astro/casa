 ...
 */
	...
	string ObservationTable::toXML()  {
		...
		buf.append("<ObservationTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:obsrvn=\"http://Alma/XASDM/ObservationTable\" xsi:schemaLocation=\"http://Alma/XASDM/ObservationTable http://almaobservatory.org/XML/XASDM/2/ObservationTable.xsd\" schemaVersion=\"2\" schemaRevision=\"1.53\">\n");
	...
	string ObservationTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<ObservationTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:obsrvn=\"http://Alma/XASDM/ObservationTable\" xsi:schemaLocation=\"http://Alma/XASDM/ObservationTable http://almaobservatory.org/XML/XASDM/2/ObservationTable.xsd\" schemaVersion=\"2\" schemaRevision=\"1.53\">\n";
   ...
   //
    ...
    if (boost::filesystem::exists(boost::filesystem::path(directory + "/Observation.xml")))
      setFromXMLFile(directory);
    else if (boost::filesystem::exists(boost::filesystem::path(directory + "/Observation.bin")))
