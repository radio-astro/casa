//# MultiEllipseTool.h: Base class for MultiWorldCanvas event-based rectangle tools
...
#ifndef DISPLAY_MULTIELLIPSETOOL_H
#define DISPLAY_MULTIELLIPSETOOL_H
...
// resizing and moving rectangles on a WorldCanvas.  While MultiEllipseTool
...
// </motivation>
    ...
    class MultiEllipseTool : public MultiRectTool {
	...
	public:
	    ...
	    RegionToolTypes type( ) const { return ELLIPSETOOL; }
