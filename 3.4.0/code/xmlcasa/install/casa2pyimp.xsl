...
<xsl:template match="aps:input"> <xsl:call-template name="doargs3"/>):
</xsl:template>
...
<xsl:template name="doargs3">
<xsl:for-each select="aps:param">
<xsl:choose>
<xsl:when test="lower-case(@type)='any'"><xsl:value-of select="@name"/>=<xsl:call-template name="handleonevalue"/><xsl:if test="position()&lt;last()">, </xsl:if></xsl:when>
<xsl:when test="lower-case(@type)='variant'"><xsl:value-of select="@name"/>=<xsl:call-template name="handleonevalue"/><xsl:if test="position()&lt;last()">, </xsl:if></xsl:when>
<xsl:when test="lower-case(@type)='record'"><xsl:value-of select="@name"/>=<xsl:call-template name="handleonevalue"/><xsl:if test="position()&lt;last()">, </xsl:if></xsl:when>
<xsl:when test="lower-case(@type)='string'"><xsl:value-of select="@name"/>=&apos;<xsl:value-of select="aps:value"/>&apos;<xsl:if test="position()&lt;last()">, </xsl:if></xsl:when>
<xsl:when test="lower-case(@type)='boolarray'"><xsl:value-of select="@name"/>=[<xsl:value-of select="aps:value"/>]<xsl:if test="position()&lt;last()">, </xsl:if></xsl:when>
<xsl:when test="lower-case(@type)='stringarray'"><xsl:value-of select="@name"/>=[<xsl:apply-templates select="aps:value"><xsl:with-param name="arraytype"><xsl:value-of>string</xsl:value-of></xsl:with-param></xsl:apply-templates>]<xsl:if test="position()&lt;last()">, </xsl:if></xsl:when>
<xsl:when test="lower-case(@type)='intarray'"><xsl:value-of select="@name"/>=[<xsl:apply-templates select="aps:value"><xsl:with-param name="unitsare"><xsl:if test="@units"><xsl:value-of select="@units"/></xsl:if></xsl:with-param></xsl:apply-templates>]<xsl:if test="position()&lt;last()">, </xsl:if></xsl:when>
<xsl:when test="lower-case(@type)='doublearray'"><xsl:value-of select="@name"/>=[<xsl:apply-templates select="aps:value"><xsl:with-param name="unitsare"><xsl:if test="@units"><xsl:value-of select="@units"/></xsl:if></xsl:with-param></xsl:apply-templates>]<xsl:if test="position()&lt;last()">, </xsl:if></xsl:when>
<xsl:otherwise>
<xsl:value-of select="@name"/>=<xsl:if test="@units!=''">&apos;</xsl:if><xsl:value-of select="aps:value"/><xsl:if test="@units!=''"><xsl:value-of select="@units"/>&apos;</xsl:if><xsl:if test="position()&lt;last()">, </xsl:if>
</xsl:otherwise>
</xsl:choose>
</xsl:for-each>
</xsl:template>
...
<xsl:for-each select="aps:value[position() eq 1]">
<xsl:choose>
<xsl:when test="lower-case(@type)='string'">
<xsl:text>&apos;</xsl:text><xsl:value-of select="." disable-output-escaping="yes"></xsl:value-of><xsl:text>&apos;</xsl:text>
</xsl:when>
