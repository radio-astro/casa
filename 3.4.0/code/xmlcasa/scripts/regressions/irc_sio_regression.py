...
max=spave.stats('max',linemask)	   	#  IF[30] = 0.618
sum=spave.stats('sum',linemask)	   	#  IF[30] = 159.841
median=spave.stats('median',linemask) 	#  IF[30] = 0.439
mean=spave.stats('mean',linemask) 	#  IF[30] = 0.354
											# Chans  bchan    echan      Xmin      Xmax        Ymin     Ymax
...
diff_max = abs((0.6180-max[0])/0.6180)
diff_rms = abs((0.01853-rms[0])/0.01853)
diff_sum = abs((159.8-sum[0])/159.8)
