/*============================================================================
    ...
    $Id: wcsunits.h,v 4.3 2007/12/27 05:41:36 cal103 Exp $
*=============================================================================
*
...
*                        a FITS header keyrecord are also handled.  If the
*                        first non-blank character in unitstr is '[' then the
*                        unit string is delimited by its matching ']'.  Blanks
