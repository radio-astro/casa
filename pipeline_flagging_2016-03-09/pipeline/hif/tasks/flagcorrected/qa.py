...
class FlagcorrectedQAHandler(pqa.QAResultHandler):    
    """
    QA handler for an uncontained FlagcorrectedResult.
    """
    result_cls = resultobjects.FlagcorrectedResults
    child_cls = None
...
class FlagcorrectedListQAHandler(pqa.QAResultHandler):
    """
