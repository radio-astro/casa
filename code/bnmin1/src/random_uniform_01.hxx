 ...
 * based on boost random/uniform_01.hpp header file
...
#ifndef _BNMIN1_RANDOM_UNIFORM_01_HXX
...
class backward_compatible_uniform_01
{
  ...
  typedef random::detail::pass_through_engine<UniformRandomNumberGenerator> internal_engine_type;
public:
