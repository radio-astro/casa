 ...
 * based on boost random/detail/uniform_int_float.hpp header file
...
#ifndef _BNMIN1_RANDOM_DETAIL_PASS_THROUGH_ENGINE_HXX_
#define _BNMIN1_RANDOM_DETAIL_PASS_THROUGH_ENGINE_HXX_
