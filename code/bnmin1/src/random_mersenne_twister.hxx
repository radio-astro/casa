 ...
 * based on boost random/mersenne_twister.hpp header file
...
#ifndef _BNMIN1_RANDOM_MERSENNE_TWISTER_HXX_
#define _BNMIN1_RANDOM_MERSENNE_TWISTER_HXX_
...
public:
  ...
  BNMIN1_RANDOM_DETAIL_ARITHMETIC_CONSTRUCTOR(mersenne_twister, UIntType, value)
  { seed(value); }
  template<class It> mersenne_twister(It& first, It last) { seed(first,last); }

  BNMIN1_RANDOM_DETAIL_GENERATOR_CONSTRUCTOR(mersenne_twister, Generator, gen)
  { seed(gen); }
  ...
  BNMIN1_RANDOM_DETAIL_ARITHMETIC_SEED(mersenne_twister, UIntType, value)
  {
...
BNMIN1_RANDOM_PTR_HELPER_SPEC(boost::mt19937)
