...
public:
	PercentageCalculator( float minValue, float maxValue, const CountedPtr<const ImageInterface<Float> > image );
	void work();
...
public:
    ...
    void setImage(const CountedPtr<const ImageInterface<Float > > image );
    void hideMaximum();
