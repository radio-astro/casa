...
#ifndef ACTION_SUMMARY_DIALOG_H_
#define ACTION_SUMMARY_DIALOG_H_
...
/**
 * Displays a dialog allowing the user to specify the data that
 * they want summarized.
 */
class ActionSummaryDialog : public PlotMSAction {
public:
