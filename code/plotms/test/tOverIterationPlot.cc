...
/**
 * Tests whether an overplot consisting of scan and field can be
 * iterated over antenna
 */
int main(int /*argc*/, char** /*argv[]*/) {
    ...
    //the x-axis properties here.
     ...
     //Now make it into an iteration plot over antenna.
     ...
     iterationParams->setIterationAxis( PMS::ANTENNA );
	...
	ok = tUtil::checkFile( outFile1, 175000, 205000, -1 );
