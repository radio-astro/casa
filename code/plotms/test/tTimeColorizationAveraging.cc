...
/**
 * Tests whether a elevation/amp plot can be colorized with respect to averaged time.
 */
int main(int /*argc*/, char** /*argv[]*/) {

	String dataPath= tUtil::getFullPath( "pm_ngc5921.ms" );
    cout << "tTimeColorizationAveraging using data from "<<dataPath.c_str()<<endl;
    ...
    //Set time averaging of 3600 seconds.
    ...
    String outFile( "/tmp/plotTimeColorAverageTest.jpg");
	...
	ok = tUtil::checkFile( outFile, 50000, 70000, -1 );
	cout << "tTimeColorizationAveraging:: Result of  save file check="<<ok<<endl;
