...
public:
    ...
    PlotMSIndexer(PlotMSCacheBase* plotmscache,
    ...
    bool maskedMinsMaxes(double& xMin, double& xMax,
                         double& yMin,double& yMax);
    bool unmaskedMinsMaxes(double& xMin, double& xMax,
                           double& yMin,double& yMax);
    // </group>
    ...
    bool maskedMinsMaxesRaw(double& xMin, double& xMax,
                            double& yMin,double& yMax);
    bool unmaskedMinsMaxesRaw(double& xMin, double& xMax,
                              double& yMin,double& yMax);
    ...
    Int getIndex0100(Int ch,Int irel) {
        return (irel / nperchan_(ch)) % ichanmax_(ch); }
    Int getIndex0010(Int ch,Int irel) {
        return (irel / nperbsln_(ch)) % ibslnmax_(ch); }
    Int getIndex0110(Int ch,Int irel) {
        return (irel / nperchan_(ch)) % ichanbslnmax_(ch); }
    Int getIndex1010(Int ch,Int irel) {
        return (irel / nperbsln_(ch)) * nperchan_(ch) + irel % nperchan_(ch); }
    Int getIndex1110(Int ch,Int irel) { return irel % idatamax_(ch); }
    Int getIndex0001(Int ch,Int irel) {
        return (irel / nperant_(ch)) % iantmax_(ch); }
...
private:
    ...
    */
    ...
    // In the future we may want to cache ALL ranges for all loaded
    // values to avoid recomputation.
    void computeRanges();
