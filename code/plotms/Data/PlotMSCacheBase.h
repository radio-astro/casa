...
public:
    ...
    inline bool hasReferenceValue(PMS::Axis axis) {
        return (axis == PMS::TIME && cacheReady()); }
    inline double referenceValue(PMS::Axis axis) {
        return (hasReferenceValue(axis) ? refTime() : 0.0); }
    ...
    inline Double getScan(Int chnk, Int)     { return scan_(chnk); }
    inline Double getField(Int chnk, Int)    { return field_(chnk); }
    inline Double getTime(Int chnk, Int)     { return time_(chnk); }
    inline Double getTimeIntr(Int chnk, Int) { return timeIntr_(chnk); }
    inline Double getSpw(Int chnk, Int)      { return spw_(chnk); }

    inline Double getFreq(Int chnk, Int irel) {
        return *(freq_[chnk]->data() + irel); }

    inline Double getVel(Int chnk, Int irel) {
        return *(vel_[chnk]->data() + irel); }

    inline Double getChan(Int chnk, Int irel) {
        return *(chan_[chnk]->data() + irel); }

    inline Double getCorr(Int chnk, Int irel) {
        return *(corr_[chnk]->data() + irel); }

    inline Double getAnt1(Int chnk, Int irel) {
        return *(antenna1_[chnk]->data() + irel); }

    inline Double getAnt2(Int chnk, Int irel) {
        return *(antenna2_[chnk]->data() + irel); }

    inline Double getBsln(Int chnk, Int irel) {
        return *(baseline_[chnk]->data() + irel); }

    inline Double getUVDist(Int chnk, Int irel) {
        return *(uvdist_[chnk]->data() + irel); }

    inline Double getUVDistL(Int chnk, Int irel) {
        return *(uvdistL_[chnk]->data() + irel); }

    inline Double getU(Int chnk, Int irel) {
        return *(u_[chnk]->data() + irel); }

    inline Double getV(Int chnk, Int irel) {
        return *(v_[chnk]->data() + irel); }

    inline Double getW(Int chnk, Int irel) {
        return *(w_[chnk]->data() + irel); }

    inline Double getUwave(Int chnk, Int irel) {
        return *(uwave_[chnk]->data() + irel); }

    inline Double getVwave(Int chnk, Int irel) {
        return *(vwave_[chnk]->data()+irel); };

    inline Double getWwave(Int chnk, Int irel) {
        return *(wwave_[chnk]->data() + irel); }

    inline Double getAmp(Int chnk, Int irel) {
        return *(amp_[chnk]->data() + irel); }

    inline Double getPha(Int chnk, Int irel) {
        return *(pha_[chnk]->data() + irel); }

    inline Double getReal(Int chnk, Int irel) {
        return *(real_[chnk]->data() + irel); }

    inline Double getImag(Int chnk, Int irel) {
        return *(imag_[chnk]->data() + irel); }

    inline Double getFlag(Int chnk, Int irel) {
        return *(flag_[chnk]->data() + irel); }

    inline Double getFlagRow(Int chnk, Int irel) {
        return *(flagrow_[chnk]->data() + irel); }

    inline Double getRow(Int chnk, Int irel) {
        return *(row_[chnk]->data() + irel); }

    inline Double getWt(Int chnk, Int irel) {
        return *(wt_[chnk]->data() + irel); }

    // These are array-global (one value per chunk)
    inline Double getAz0(Int chnk, Int) { return az0_(chnk); }
    inline Double getEl0(Int chnk, Int) { return el0_(chnk); }
    inline Double getHA0(Int chnk, Int) { return ha0_(chnk); }
    inline Double getPA0(Int chnk, Int) { return pa0_(chnk); }

    // These are antenna-based
    inline Double getAntenna(Int chnk, Int irel) {
        return *(antenna_[chnk]->data() + irel); }

    inline Double getAz(Int chnk, Int irel) {
        return *(az_[chnk]->data()+irel); }

    inline Double getEl(Int chnk, Int irel) {
        return *(el_[chnk]->data() + irel); }

    inline Double getParAng(Int chnk, Int irel) {
        return *(parang_[chnk]->data() + irel); }

    // These support generic non-complex calibration
    inline Double getPar(Int chnk,Int irel) {
        return *(par_[chnk]->data() + irel); }
...
protected:
    ...
    // Set the net axes mask
    // (defines how to collapse flags for the chosen plot axes)
    ...
    // Returns the number of points loaded for the given axis
    // or 0 if not loaded
    ...
    // Logs the given message from the given method name as the
    // given event type (see PlotLogger).
    ...
    // Global ranges
    Double xminG_, yminG_, xflminG_, yflminG_,
        xmaxG_, ymaxG_, xflmaxG_, yflmaxG_;
