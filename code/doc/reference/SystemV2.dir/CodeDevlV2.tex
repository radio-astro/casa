...
$ $Id: CodeDevlV2.tex 6675 2008-11-25 17:36:38Z wes.young $ $}.
...
\item
   ...
   invoke \exeref{casainit} to define the \aipspp\ environment.

\item
   Invoke \exeref{mktree.svn} to create an \aipspp\ workspace.
\end{itemize}
...
can use \exeref{casainit} to switch between architectures at any time.
...
workspaces by \exeref{mktree.svn}.
...
\item
   ...
   \item
      ...
      packages (see \exeref{mktree.svn}).
   \item
...
\item
   ...
   symlink (see \exeref{mktree.svn}), and initiating a \exeref{gmake} within it.
