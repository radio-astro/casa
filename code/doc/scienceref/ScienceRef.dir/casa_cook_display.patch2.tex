...
than one plane for frequency or polarization) then it will be on the
...
\item {\bf Tools}
  \begin{itemize}
      ...
      \item {\tt Region Manager} --- save regions and control their exrent 
  \end{itemize}
\item {\bf View}
  \begin{itemize}
...
\begin{itemize}
   ...
   \item {\bf region save} ({\tt Tools:Region Manager}) --- save/control
    regions (button not shown in all figures).
