...
ASAP is
imported as the {\tt sd} tool.  It forms the basis for a series
...
\end{verbatim}
    ...
    simultaneously:  channel based flaggingÊ can be executedÊ using the
    flag regions specified in {\tt maskflag} Êif no row is given in {\tt flagrow},
