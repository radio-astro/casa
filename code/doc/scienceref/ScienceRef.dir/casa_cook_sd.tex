...
{\bf R3.0.1 New Features:}
Several parameters are modified to align with {\tt simdata}. See
the section of {\tt simdata} for the details of the parameters. %% Add proper TeX reference here
