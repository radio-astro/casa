...
%% describe here how a multi-MS is layed in disk etc
...
It is important that the user sets the separation axis correctly when first
...
Depending on the structure of the data, some subMSs will have empty data.
