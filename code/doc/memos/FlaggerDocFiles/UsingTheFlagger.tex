...
agentClip={'mode':'clip','clipminmax':[0.,6.],'datacolumn':'CPARAM'}
af.parseagentparameters(agentClip)
af.init()
...
INFO	Clip::setAgentParameters	data column is CPARAM
...
elements or '' to select all the elements (which is also the default):
...
agentClip={'mode':'clip','clipminmax':[0.,600.],'datacolumn':'FPARAM','correlation':''}
af.parseagentparameters(agentClip)
af.init()
...
