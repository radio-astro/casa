...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{What's New in Release 3.1}
\label{section:intro.release.whatsnew}

\begin{itemize}
\item {\bf  Simulation}
 \begin{itemize}
\item  {\tt simdata2} is renamed to {\tt simdata} and should no longer crash
  when adding noise.  The legacy interface is now called {\tt oldsimdata}.
 \end{itemize}
\end{itemize}
