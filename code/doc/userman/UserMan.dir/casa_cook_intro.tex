...
%    \item  {\tt pclean}: Taylor term expansion with {\it nterms>1} is available as
...
%    \item  the Taylor term expansion mode ({\it mode='mfs';nterms>1}) has better speed and memory performance by
%introducing the use of image patches for minor-cycle updates
