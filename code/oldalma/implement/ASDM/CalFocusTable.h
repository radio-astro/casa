...
public:
	...
	/**
	  ...
	  * Provided to facilitate the call from Python, otherwise the newRow method will be preferred.
	  */
	 CalFocusRow *newRowCopy(CalFocusRow *row); 
	...
	/**
	 * Get all rows.
	 * @return Alls rows as a vector of pointers of CalFocusRow. The elements of this vector are stored in the order 
...
// In all cases we maintain a private ArrayList of CalFocusRow s.
