...
DataDescriptionRow* DataDescriptionTable::lookup(Tag polOrHoloId, Tag spectralWindowId) {
	...
	string DataDescriptionTable::toXML()  {
		...
		buf.append("<DataDescriptionTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:dtdsc=\"http://Alma/XASDM/DataDescriptionTable\" xsi:schemaLocation=\"http://Alma/XASDM/DataDescriptionTable http://almaobservatory.org/XML/XASDM/3/DataDescriptionTable.xsd\" schemaVersion=\"3\" schemaRevision=\"1.60\">\n");
	...
	string DataDescriptionTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<DataDescriptionTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:dtdsc=\"http://Alma/XASDM/DataDescriptionTable\" xsi:schemaLocation=\"http://Alma/XASDM/DataDescriptionTable http://almaobservatory.org/XML/XASDM/3/DataDescriptionTable.xsd\" schemaVersion=\"3\" schemaRevision=\"1.60\">\n";
	...
	if (getContainer().checkRowUniqueness()) {
    	try {
      		for (uint32_t i = 0; i < this->declaredSize; i++) {
				DataDescriptionRow* aRow = DataDescriptionRow::fromBin(eiss, *this, attributesSeq);
				checkAndAdd(aRow);
      		}
    	}
