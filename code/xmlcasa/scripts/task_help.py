...
def tasklist():
    ...
    print 'exportuvfits        listobs       flagdata2     plotxy'
    print '(importasdm)        listvis       flagmanager   imview'
    print '(importgmrt)        vishead       plotms        msview'
    print '                    visstat       plotxy'	 
    print ' '
    print ''
    ...
    print '                            startup             sdlist'
    print '                            taskhelp            sdmath'
    print '                            tasklist            sdplot'
