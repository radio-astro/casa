"""Module to calculate median and MAD of a data 'view'."""
...
# last resort - offer built in description

                self._htmlLogger.logHTML("""
                 <p>The data view is a list of 1-d arrays (actually 2-d but 
                 the length of one axis is 1). Each point in an array is the
                 median of the sequence of points from a cut down the '%s' axis 
                 of the input 'view object' described below. Associated with
                 each point is an error estimate that is the median absolute 
                 deviation (%s) of the sequence.""" % (self._collapseAxis,
...
# last resoirt - offere built-in description

                self._htmlLogger.logHTML("""
                 <p>The data view is a list of 1-d arrays, derived by 
                 collapsing the %s axis of each 2-d array in the list
                 generated by the input 'view object' described below. 
                 Each 'collapsed' point is the median absolute deviation
                 (%s) of the input sequence of points.""" % 
