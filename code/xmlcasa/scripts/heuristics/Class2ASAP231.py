...
# Class2ASAP231.py
#
# This function is identical to Class2ASAP.py except that Class2ASAP.py
# is working on older version of casapy (20.0.5654-001 or former) while
# Class2ASAP231.py is working on newer version of casapy (23.1.6826-001
# or later).
#
###
import math
...
def Class2ASAP(filenamein, filenameRoot, ExposureTime=10.0, ExposureLag=3.0, MetaFile=False):
    ...
    hdr.update('SPECSYS','LSRK',after='LST')
