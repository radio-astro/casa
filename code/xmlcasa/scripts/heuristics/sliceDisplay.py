...
#        yoff = self._plotText(0.0, yoff, 'Calculation History:', 50,
#         ny_subplot=ny_subplot)
#        yoff = self._plotText(0.05, yoff,
...
# flagged at this reduction stage so give full information on the rules
                ...
                for rule in flagReason['rules']:
                    if rule.has_key('colour'):
                        pylab.errorbar(xoff, yoff, 0.0, fmt='^', color=
                         rule['colour'])
