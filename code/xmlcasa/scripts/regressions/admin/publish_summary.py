        ...
        for k in range(self.numTests) :
            ...
            try:
                ...
                if errorcode != 0:
                    ...
                    if len(allrevision.split("Revision")) > 2:
                        print "Warning: Multiple data versions found:", allrevision
                        datasvnr += " (incomplete)"

                self.result_common['data_version'] = "'"+datasvnr+"'", "Data repository SVN revision"
