...
momonestat=imstat('leo2pt_regression.concat_chanbary.taper1600.cleanmosft.moment1', robust=True)
try:
...
try:
    momoneplane0=imstat('leo2pt_regression.concat_chanbary.taper1600.cleanmosft.plane0.mom1', robust=True)
...
try:
    momoneplane255=imstat('leo2pt_regression.concat_chanbary.taper1600.cleanmosft.plane255.mom1', robust=True)
