...
#        
#    def test12(self):
#        """Test 12: Correct psfmode values"""
...
#        self.res = clean(vis=self.msfile,imagename=self.img, cell=2.0)
#        self.assertEqual(self.res, None)
#        self.assertTrue(os.path.exists(self.img+'.image'))
#        
#    def test20(self):
...
#        
#    def test23(self):
#        '''Test 23: Correct weighting modes'''
#        modes = ['natural','uniform','briggs','superuniform','briggsabs','radial']
#        for m in modes:
#            out = self.img+'_'+m
...
#            self.assertTrue(os.path.exists(out+'.image'))
    ...
    def test24(self):
        '''Test 24: Correct subparameters of selectdata'''
