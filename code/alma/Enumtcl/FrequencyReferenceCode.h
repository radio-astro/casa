...
public:
  ...
  static bool   init(){
    EnumPar<void> ep;
    m_.insert(pair<FrequencyReferenceCodeMod::FrequencyReferenceCode,EnumPar<void> >
  ...
  static map<FrequencyReferenceCodeMod::FrequencyReferenceCode,EnumPar<void> > m_;
};
