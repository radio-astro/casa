...
template<>
 struct enum_set_traits<CorrelatorType> : public enum_set_traiter<CorrelatorType,3,CorrelatorTypeMod::FXF> {};

template<>
class enum_map_traits<CorrelatorType,void> : public enum_map_traiter<CorrelatorType,void> {
public:
  static bool   init_;
  ...
  static bool   init(){
    EnumPar<void> ep;
    m_.insert(pair<CorrelatorType,EnumPar<void> >
  ...
  static map<CorrelatorType,EnumPar<void> > m_;
};
