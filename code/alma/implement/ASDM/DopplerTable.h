...
public:
	...
	/**
	  ...
	  * Provided to facilitate the call from Python, otherwise the newRow method will be preferred.
	  */
	 DopplerRow *newRowCopy(DopplerRow *row); 
	...
	/**
 	 * Returns a vector of pointers on rows whose key element <<AutoIncrementableAttribute>> dopplerId 
	 * is equal to the parameter <<AutoIncrementableAttribute>> dopplerId.
...
// In all cases we maintain a private ArrayList of DopplerRow s.
