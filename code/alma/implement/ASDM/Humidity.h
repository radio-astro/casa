//Humidity.h generated on 'mer jan 13 11:28:27 CET 2010'. Edit at your own risk.
/*
...
/**
 * The Humidity class implements a quantity of humidity in percent. class implements a quantity of angle in radians.
 * 
...
public:
	 ...
	 * 
	 * @param a cons ref to an IDLHumidity.
	 */
	 ...
	 * @param d a value in double precision.
	 */
	Humidity operator * (const double d) const;
	/**
	 * Division operator.
	 * @param d a value in double precision.
	 */
