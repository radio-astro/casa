...
public:
	...
	/**
	  ...
	  * Provided to facilitate the call from Python, otherwise the newRow method will be preferred.
	  */
	 ReceiverRow *newRowCopy(ReceiverRow *row); 
	...
	/**
 	 * Returns a vector of pointers on rows whose key element <<AutoIncrementableAttribute>> receiverId 
	 * is equal to the parameter <<AutoIncrementableAttribute>> receiverId.
...
// In all cases we maintain a private ArrayList of ReceiverRow s.
