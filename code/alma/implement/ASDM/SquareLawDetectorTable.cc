...
SquareLawDetectorRow* SquareLawDetectorTable::lookup(int numBand, DetectorBandTypeMod::DetectorBandType bandType) {
	...
	char *SquareLawDetectorTable::toFITS() const  {
		throw ConversionException("Not implemented","SquareLawDetector");
	}

	void SquareLawDetectorTable::fromFITS(char *fits)  {
		throw ConversionException("Not implemented","SquareLawDetector");
	}

	string SquareLawDetectorTable::toVOTable() const {
		throw ConversionException("Not implemented","SquareLawDetector");
	}

	void SquareLawDetectorTable::fromVOTable(string vo) {
		throw ConversionException("Not implemented","SquareLawDetector");
	}
	...
	string SquareLawDetectorTable::toXML()  {
		...
		buf.append("<SquareLawDetectorTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns=\"http://Alma/XASDM/SquareLawDetectorTable\" xsi:schemaLocation=\"http://Alma/XASDM/SquareLawDetectorTable http://almaobservatory.org/XML/XASDM/2/SquareLawDetectorTable.xsd\"> ");	
		...
		// cout << "Entering setFromMIME" << endl;
	 	...
	 	try {
	 		for (int i = 0; i < numRows; i++) {
	 			SquareLawDetectorRow* aRow = SquareLawDetectorRow::fromBin(eiss, *this);
	 			checkAndAdd(aRow);
	 		}
	 	}
