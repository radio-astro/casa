...
public:
	...
	/**
	  ...
	  * Provided to facilitate the call from Python, otherwise the newRow method will be preferred.
	  */
	 CorrelatorModeRow *newRowCopy(CorrelatorModeRow *row); 
	 ...
	 * @param x. A pointer on the row to be added.
 	 * @returns a CorrelatorModeRow pointer.
	 */	 
	...
	/**
	 * Get all rows.
	 * @return Alls rows as a vector of pointers of CorrelatorModeRow. The elements of this vector are stored in the order 
...
// In all cases we maintain a private ArrayList of CorrelatorModeRow s.
