...
public:
	 ...
	 */
	  ...
	  * @table the SquareLawDetectorTable to which the row built by deserialization will be parented.
	  */
	 static SquareLawDetectorRow* fromBin(EndianISStream& eiss, SquareLawDetectorTable& table);	 
