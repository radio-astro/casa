...
namespace asdm {
	...
	const vector<string> CalDataTable::attributesNames = initAttributesNames();
 ...
 */
	 ...
	 */
	vector<string> CalDataTable::initAttributesNames() {
...
CalDataRow* CalDataTable::lookup(ArrayTime startTimeObserved, ArrayTime endTimeObserved, EntityRef execBlockUID, CalDataOriginMod::CalDataOrigin calDataType, CalTypeMod::CalType calType, int numScan, vector<int > scanSet) {
	...
	string CalDataTable::toXML()  {
		...
		buf.append("<CalDataTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:cldata=\"http://Alma/XASDM/CalDataTable\" xsi:schemaLocation=\"http://Alma/XASDM/CalDataTable http://almaobservatory.org/XML/XASDM/2/CalDataTable.xsd\" schemaVersion=\"2\" schemaRevision=\"1.55\">\n");
	...
	string CalDataTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<CalDataTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:cldata=\"http://Alma/XASDM/CalDataTable\" xsi:schemaLocation=\"http://Alma/XASDM/CalDataTable http://almaobservatory.org/XML/XASDM/2/CalDataTable.xsd\" schemaVersion=\"2\" schemaRevision=\"1.55\">\n";
