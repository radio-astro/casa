...
public:
	...
	/**
	  ...
	  * Provided to facilitate the call from Python, otherwise the newRow method will be preferred.
	  */
	 BeamRow *newRowCopy(BeamRow *row); 
	 ...
	 */	
	void fromIDL(BeamTableIDL x) throw(DuplicateKey,ConversionException);
#endif
...
private:
	 ...
	 */
	BeamRow* checkAndAdd(BeamRow* x) throw (DuplicateKey, UniquenessViolationException);



// A data structure to store the pointers on the table's rows.

// In all cases we maintain a private ArrayList of BeamRow s.
