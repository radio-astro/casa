...
public:
	...
	/**
	  ...
	  * Provided to facilitate the call from Python, otherwise the newRow method will be preferred.
	  */
	AnnotationRow *newRowFull(ArrayTime time, string issue, string details);
	...
	/**
	  ...
	  * Provided to facilitate the call from Python, otherwise the newRow method will be preferred.
	  */
	 AnnotationRow *newRowCopy(AnnotationRow *row); 
	 ...
	 * @param x. A pointer on the row to be added.
 	 * @returns a AnnotationRow pointer.
	 */	 
