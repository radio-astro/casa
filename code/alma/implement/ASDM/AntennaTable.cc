...
namespace asdm {
	...
	const vector<string> AntennaTable::attributesNames = initAttributesNames();
 ...
 */
	 ...
	 */
	vector<string> AntennaTable::initAttributesNames() {
...
AntennaRow* AntennaTable::lookup(string name, AntennaMakeMod::AntennaMake antennaMake, AntennaTypeMod::AntennaType antennaType, Length dishDiameter, vector<Length > position, vector<Length > offset, ArrayTime time, Tag stationId) {
	...
	string AntennaTable::toXML()  {
		...
		buf.append("<AntennaTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:antnn=\"http://Alma/XASDM/AntennaTable\" xsi:schemaLocation=\"http://Alma/XASDM/AntennaTable http://almaobservatory.org/XML/XASDM/2/AntennaTable.xsd\" schemaVersion=\"2\" schemaRevision=\"1.55\">\n");
	...
	string AntennaTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<AntennaTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:antnn=\"http://Alma/XASDM/AntennaTable\" xsi:schemaLocation=\"http://Alma/XASDM/AntennaTable http://almaobservatory.org/XML/XASDM/2/AntennaTable.xsd\" schemaVersion=\"2\" schemaRevision=\"1.55\">\n";
