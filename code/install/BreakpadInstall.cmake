...
macro (configure_breakpad Breakpad_Root)
    ...
    set (configCommand "./configure CC=${CMAKE_C_COMPILER} CXX=${CMAKE_CXX_COMPILER}")
	message ("configCommand ${configCommand}")
    execute_process (COMMAND ./configure CC=${CMAKE_C_COMPILER} CXX=${CMAKE_CXX_COMPILER}
...
macro (install_breakpad Breakpad_Root Breakpad_ArchiveFile Breakpad_ArchiveUrl)
	...
	if( APPLE )
        if (NOT EXISTS ${Breakpad_Root}/breakpad-distro/src/client/mac/build/Release/Breakpad.framework/Versions/A/Resources/breakpadUtilities.dylib)
	    set (rebuild true)
        endif ()
    else ()
