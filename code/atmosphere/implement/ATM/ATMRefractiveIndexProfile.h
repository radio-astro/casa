...
namespace atm {
  ...
  class RefractiveIndexProfile : public AtmProfile ,  public SpectralGrid{
    ...
    private:
      ...
      complex<double> mkAbs_o2(Temperature tt, Pressure pp, Pressure eh2o, Frequency nu);
      complex<double> mkAbs_o2_vib(Temperature tt, Pressure pp, Pressure eh2o, Frequency nu);
      complex<double> mkAbs_16o18o(Temperature tt, Pressure pp, Pressure eh2o, Frequency nu);
      complex<double> mkAbs_16o17o(Temperature tt, Pressure pp, Pressure eh2o, Frequency nu);
      complex<double> mkAbs_co(Temperature tt, Pressure pp, Frequency nu);
      complex<double> mkAbs_n2o(Temperature tt, Pressure pp, Frequency nu);
      complex<double> mkAbs_cnth2o(Temperature tt, Pressure pp, Pressure eh2o, Frequency nu);
      complex<double> mkAbs_cntdry(Temperature tt, Pressure pp, Pressure eh2o, Frequency nu);
      complex<double> mkAbs_h2o(Temperature tt, Pressure pp, Pressure eh2o, Frequency nu);
      complex<double> mkAbs_h2o_v2(Temperature tt, Pressure pp, Pressure eh2o, Frequency nu);
      complex<double> mkAbs_hh18o(Temperature tt, Pressure pp, Pressure eh2o, Frequency nu);
      complex<double> mkAbs_hh17o(Temperature tt, Pressure pp, Pressure eh2o, Frequency nu);
      complex<double> mkAbs_hdo(Temperature tt, Pressure pp, Pressure eh2o, Frequency nu);
      complex<double> mkAbs_o3(Temperature tt, Pressure pp, Frequency nu);
      complex<double> mkAbs_o3_161618(Temperature tt, Pressure pp, Frequency nu);
      complex<double> mkAbs_o3_161617(Temperature tt, Pressure pp, Frequency nu);
      complex<double> mkAbs_o3_161816(Temperature tt, Pressure pp, Frequency nu);
      complex<double> mkAbs_o3_161716(Temperature tt, Pressure pp, Frequency nu);

      Frequency linebroadening(Frequency nu, Temperature tt, Pressure pp, double mmol, Frequency dv0_lines, double texp_lines);
      Frequency linebroadening_water(Frequency nu, Temperature tt, Pressure pp, Pressure eh2o, double ensanche1,double ensanche2,double ensanche3,double ensanche4);
      Frequency linebroadening_hh18o_hh17o(Frequency nu, Temperature tt, Pressure pp, Pressure ph2o, double dv0, double dvlm, double temp_exp);
      Frequency linebroadening_o2(Frequency nu, Temperature tt, Pressure pp, Pressure ph2o, double mmol, double ensanche1,double ensanche2);
      Frequency interf_o2(Temperature tt, Pressure pp, double ensanche3,double ensanche4);
      complex<double> lineshape(Frequency nu, Frequency linefreq, Frequency linebroad, Frequency interf);
