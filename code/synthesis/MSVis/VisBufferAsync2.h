...
class ROVisibilityIteratorAsync2;
...
class VisBufferAsync2 : public VisBuffer2 {
...
public:
    ...
    virtual VisBufferAsync2 & assign (const VisBuffer & vb, Bool copy);
...
protected:
    ...
    VisBufferAsync2 ();
    VisBufferAsync2 (const VisBufferAsync2 & other);
    VisBufferAsync2 (ROVisibilityIterator & iter);
