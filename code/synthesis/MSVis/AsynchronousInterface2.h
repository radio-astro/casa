...
public:
    ...
    virtual void apply (ROVisibilityIterator2 *) const = 0;
...
public:
    ...
    void apply (ROVisibilityIterator2 *) const;
...
public:
    ...
    void apply (ROVisibilityIterator2 *);
    void clearAndFree ();
...
//    of data accessed from a single position of a ROVisibilityIterator2.  It contains a
...
//    fill it with the data from the next position of the ROVisibilityIterator2; a buffer is free for
...
public:
    ...
    VisBufferAsync2 * readStart (SubChunkPair);
...
createWriteData (const SubChunkPair & subchunkPair,
                 const Data & data,
                 ROVisibilityIterator2::DataColumn dataColumn,
                 void (VisibilityIterator::* setter) (const Data &, ROVisibilityIterator2::DataColumn))
{
