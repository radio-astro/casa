...
VisibilityIterator2::getMeasurementSet () const
{
    CheckImplementationPointerR ();
    return impl_p->getMeasurementSet ();
}
...
{
  CheckImplementationPointerR ();
  return impl_p->existsFlagCategory();
}
...
{
    CheckImplementationPointerR ();
    return impl_p->existsWeightSpectrum ();
}
...
{
    CheckImplementationPointerR ();
    return impl_p->getDataDescriptionId ();
}
...
VisibilityIterator2::getMSD () const
{
    CheckImplementationPointerR ();
    return impl_p->getMsd ();
}
...
{
    CheckImplementationPointerR ();
    return impl_p->getMeasurementSetId ();
}

std::vector<MeasurementSet>
VisibilityIterator2::getMeasurementSets () const
{
    CheckImplementationPointerR ();
    return impl_p->getMeasurementSets ();
}
...
{
    CheckImplementationPointerR ();
    return impl_p->newSpectralWindow ();
}
...
Int
VisibilityIterator2::numberAnt ()
{
    CheckImplementationPointerR ();
    return impl_p->numberAnt ();
}

Int
VisibilityIterator2::numberCoh ()
{
    CheckImplementationPointerR ();
    return impl_p->numberCoh ();
}

Int
VisibilityIterator2::numberDDId ()
{
    CheckImplementationPointerR ();
    return impl_p->numberDDId ();
}

Int
VisibilityIterator2::numberPol ()
{
    CheckImplementationPointerR ();
    return impl_p->numberPol ();
}

Int
VisibilityIterator2::numberSpw ()
{
    CheckImplementationPointerR ();
    return impl_p->numberSpw ();
}
...
VisibilityIterator2::putModel(const RecordInterface& rec, Bool iscomponentlist, Bool incremental){
  CheckImplementationPointerW ();
  impl_p->putModel(rec, iscomponentlist, incremental);
