...
#ifndef SYNTHESIS_TRANSFORM2_TABULATEDCONVFUNC_H
#define SYNTHESIS_TRANSFORM2_TABULATEDCONVFUNC_H
...
namespace casa{
  ...
  public:
    ...
    virtual void prepareConvFunction(const VisBuffer2& /*vb*/, CFStore& /*cfs*/){};
  private:
