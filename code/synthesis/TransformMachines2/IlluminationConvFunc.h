...
#ifndef SYNTHESIS_TRANSFORM2_ILLUMINATIONCONVFUNC_H
#define SYNTHESIS_TRANSFORM2_ILLUMINATIONCONVFUNC_H

#include <casa/Exceptions.h>
#include <synthesis/TransformMachines2/TabulatedConvFunc.h>
