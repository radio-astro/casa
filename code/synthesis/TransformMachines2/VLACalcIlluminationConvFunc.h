...
namespace casa{
  ...
  public:
    ...
    void applyPB(ImageInterface<Float>& pbImage, Double& pa,//const VisBuffer2& vb, 
		 const Vector<Float>& paList, Int bandID, Bool doSquint=False);
    void applyPB(ImageInterface<Float>& pbImage, Double& pa,//const VisBuffer2& vb, 
		 Int bandID=-1, Bool doSquint=False, Double freqVal=-1.0);
    void applyPB(ImageInterface<Complex>& pbImage, Double& pa,//const VisBuffer2& vb, 
		 Bool doSquint=True,Int bandID=-1, Int muellerTerm=0, Double freqVal=-1.0);
    void applyPBSq(ImageInterface<Float>& pbImage, Double& pa,//const VisBuffer2& vb, 
		   const Vector<Float>& paList, Int bandID, Bool doSquint=False);
    void applyPBSq(ImageInterface<Float>& pbImage, Double& pa,//const VisBuffer2& vb, 
		   Int bandID=-1, Bool doSquint=False);
    void applyPBSq(ImageInterface<Complex>& pbImage, Double& pa,//const VisBuffer2& vb, 
		   Int bandID=-1,  Bool doSquint=True);
    void makeFullJones(ImageInterface<Complex>& pbImage, const VisBuffer2& vb, Bool doSquint, 
