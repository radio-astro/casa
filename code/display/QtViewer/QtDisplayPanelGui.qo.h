...
// </summary>
	...
	public slots:
		...
		// add a new DD
		virtual QtDisplayData* addDD(String path, String dataType, String displayType, Bool autoRegister=True, Bool tmpDtata=False, CountedPtr<ImageInterface<Float> > img = CountedPtr<ImageInterface<Float> >());
	...
	private slots:
		...
		virtual void addDDSlot(String path, String dataType, String displayType,
				...
				CountedPtr<ImageInterface<Float> > img = CountedPtr<ImageInterface<Float> >());
