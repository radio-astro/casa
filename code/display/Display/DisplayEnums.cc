...
// write to ostream support
	ostream & operator << (ostream & os, Display::CapStyle dmt) {
		switch(dmt) {
		case Display::CSNotLast:
			os << "CSNotLast";
			break;
		case Display::CSButt:
			os << "CSButt";
			break;
		case Display::CSRound:
			os << "CSRound";
			break;
		case Display::CSProjecting:
			os << "CSProjecting";
			break;
		}
...
// write to ostream support
	ostream & operator << (ostream & os, Display::JoinStyle dmt) {
		switch(dmt) {
		case Display::JSMiter:
			os << "JSMiter";
			break;
		case Display::JSRound:
			os << "JSRound";
			break;
		case Display::JSBevel:
			os << "JSBevel";
			break;
		}
...
// write to ostream support
	ostream & operator << (ostream & os, Display::FillRule dfr) {
		switch(dfr) {
		case Display::FREvenOdd:
			os << "FREvenOdd";
			break;
		case Display::FRWinding:
			os << "FRWinding";
			break;
		}
...
// write to ostream support
	ostream & operator << (ostream & os, Display::ArcMode dam) {
		switch(dam) {
		case Display::AMChord:
			os << "AMChord";
			break;
		case Display::AMPieSlice:
			os << "AMPieSlice";
			break;
		}
...
// write to ostream support
	...
	ostream & operator << (ostream & os, Display::Marker mrk) {
		...
		case Display::CircleAndDot:
			...
			break;
		default:
			throw(AipsError("Shouldn't get here"));
		}
		return os;
	}
...
// write to ostream support
	...
	ostream & operator << (ostream & os, Display::DisplayDataType dtype) {
		...
		case Display::Vector:
			os << "Vector";
			break;
		case Display::Annotation:
			os << "Annotation";
			break;
		case Display::CanvasAnnotation:
			os << "CanvasAnnotation";
			break;
		}
		return os;
