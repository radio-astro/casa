...
// </motivation>
	...
	public:
		...
		virtual void addTool(const String& key, const CountedPtr<MultiWCTool> & );
		...
		virtual const CountedPtr<MultiWCTool> getTool(const String& key);
	...
	private:
		...
		SimpleOrderedMap<String, CountedPtr<MultiWCTool> > itsMWCTools;
