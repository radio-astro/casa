...
// </summary>
	...
	public:
		...
		DSWorldRectangle();
		DSWorldRectangle(const casacore::Record& settings, PanelDisplay* pd);
	...
	private:
		...
		//  virtual casacore::Bool chooseWC(const casacore::Float& centerX, const casacore::Float& centerY,
		//		PanelDisplay* pdx,
		//WorldCanvas* wc);
