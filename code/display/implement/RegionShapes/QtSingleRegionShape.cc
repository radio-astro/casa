...
RegionShape* QtSingleRegionShape::shape() { return m_shape; }
RegionShape* QtSingleRegionShape::compositeParent() { return m_compositeParent; }
QtRegionShapeManager* QtSingleRegionShape::manager() { return m_parent; }
QtDisplayPanel* QtSingleRegionShape::panel() { return m_panel; }
...
RSOption QtRSOption::value() const {
    switch(m_type) {
    case RegionShape::STRING: return RSOption(m_string->text().toStdString());
    case RegionShape::STRINGCHOICE:
    ...
    case RegionShape::STRINGCHOICEARRAY: {
        ...
        return RSOption(v); }
    case RegionShape::DOUBLE: return RSOption(m_double->value());
    case RegionShape::BOOL: return RSOption(m_bool->isChecked());
    
    default: return RSOption("");
    }
}
