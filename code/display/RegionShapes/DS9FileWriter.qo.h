...
// Implementation of RegionFileWriter for writing to DS9 files.
	...
	private:
		...
		static vector<String> globalProperties() {
			...
			v[2]  = DS9Region::PROP_DASHLIST;
			v[3]  = DS9Region::PROP_DELETE;
			v[4]  = DS9Region::PROP_EDIT;
			v[5]  = DS9Region::PROP_FIXED;
			v[6]  = DS9Region::PROP_FONT;
			v[7]  = DS9Region::PROP_HIGHLITE;
			v[8]  = DS9Region::PROP_INCLUDE;
			v[9]  = DS9Region::PROP_MOVE;
			v[10] = DS9Region::PROP_ROTATE;
			v[11] = DS9Region::PROP_SELECT;
			v[12] = DS9Region::PROP_SOURCE;
			v[13] = DS9Region::PROP_WIDTH;
