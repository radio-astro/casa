...
namespace casa {
	...
	public:
		...
		public:
			...
			CountedPtr<viewer::region::region_list_type> regions( viewer::region::PointLocation loc,
		...
		private:
			...
			CountedPtr<viewer::region::region_list_type> filter( CountedPtr<viewer::region::region_list_type>,
			...
			typedef std::map< viewer::region::PointLocation, CountedPtr<viewer::region::region_list_type> > state_count_type;
