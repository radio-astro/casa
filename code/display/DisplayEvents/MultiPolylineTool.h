...
public:
	...
	virtual Bool polylineDefined() { return itsMode>=Ready;  }
	...
	RegionToolTypes type( ) const { return POLYLINETOOL; }
...
protected:
	...
	virtual bool checkType( viewer::region::RegionTypes t ) { return t == viewer::region::PolylineRegion; }
