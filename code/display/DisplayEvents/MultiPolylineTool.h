...
//
	...
	private:
		typedef std::list<CountedPtr<viewer::Polyline> > polylinelist;
		...
		CountedPtr<viewer::Polyline> resizing_region;
		CountedPtr<viewer::Polyline> creating_region;
		...
		CountedPtr<viewer::Polyline> building_polyline;
