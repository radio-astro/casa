...
// </motivation>
	...
	protected:
		...
		virtual CountedPtr<viewer::PVLine> allocate_region( WorldCanvas *wc, double x1, double y1, double x2, double y2, VOID *region_specific_state ) const;


		viewer::RegionSource *rfactory;

	private:
		typedef std::list<CountedPtr<viewer::PVLine> > pvlinelist;
		...
		CountedPtr<viewer::PVLine> resizing_region;
		CountedPtr<viewer::PVLine> creating_region;
