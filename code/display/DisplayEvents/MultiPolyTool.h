...
// </todo>
	...
	private:
		typedef std::list<CountedPtr<viewer::Polygon> > polygonlist;
		...
		CountedPtr<viewer::Polygon> resizing_region;
		CountedPtr<viewer::Polygon> creating_region;
		...
		CountedPtr<viewer::Polygon> building_polygon;
