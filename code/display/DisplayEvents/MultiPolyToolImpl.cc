//# MultiPolyToolImpl.cc: MultiWorldCanvas event-based polygon region drawer
...
namespace casa { //# NAMESPACE CASA - BEGIN
	...
	void MultiPolyToolImpl::doubleInside() {
		//cout << "doubleInside --->before region Readay" << endl;
		regionReady();
		//cout << "<------after region ready" << endl;
	}

	void MultiPolyToolImpl::getLinearCoords(Vector<Double> &x, Vector<Double> &y) {
		Vector<Int> xpix;
		Vector<Int> ypix;
		get(xpix, ypix);
		Int xs, ys, z;
	...
	void MultiPolyToolImpl::getWorldCoords(Vector<Double> &x, Vector<Double> &y) {
		Vector<Int> xpix;
		Vector<Int> ypix;
		get(xpix, ypix);
		Int xs, ys, z;
