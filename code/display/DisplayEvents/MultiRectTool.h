...
// </motivation>
	...
	protected:
		...
		virtual CountedPtr<viewer::Rectangle> allocate_region( WorldCanvas *wc, double x1, double y1, double x2, double y2, VOID *region_specific_state ) const;


		viewer::RegionSource *rfactory;

	private:
		typedef std::list<CountedPtr<viewer::Rectangle> > rectanglelist;
		...
		CountedPtr<viewer::Rectangle> resizing_region;
		CountedPtr<viewer::Rectangle> creating_region;
