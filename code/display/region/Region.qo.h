    ...
    namespace viewer {
		...
		class ImageRegion_state {
			public:
				...
				operator std::tr1::shared_ptr<ImageRegion>( ) { return imageregion; }
		...
		class Region : public QObject, public dtorNotifier {
			...
			public:
				...
				static bool refreshNeeded( int v ) { return v & region::MouseRefresh ? true : false; }
				static bool regionSelected( int v ) { return v & region::MouseSelected ? true : false; }
				static bool handleSelected( int v ) { return v & region::MouseHandle ? true : false; }
				...
				virtual bool marked( ) const { return mystate->marked( ); }
...
// --------------------==================== from old QtRegion ====================--------------------
			...
			private:
				...
				//Updates the region in the histograms.
				void updateHistogramRegion();
				void clearHistograms();
				//Add a histogram to the stack.
				//void addHistogram(ImageInterface<float>* image );
