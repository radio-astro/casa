...
// CountedPtr<Rectangle> QtRegionSourceKernel::rectangle( int blc_x, int blc_y, int trc_x, int trc_y ) {
//     return CountedPtr<Rectangle>(new QtRectangle( this, blc_x, blc_y, trc_x, trc_y ));
// }
		CountedPtr<Rectangle> QtRegionSourceKernel::rectangle( RegionCreator *rc, WorldCanvas *wc, double blc_x, double blc_y, double trc_x, double trc_y ) {
			...
			return CountedPtr<Rectangle>(result);
		}

// CountedPtr<Rectangle> QtRegionSourceKernel::rectangle( int blc_x, int blc_y, int trc_x, int trc_y ) {
//     return CountedPtr<Rectangle>(new QtRectangle( this, blc_x, blc_y, trc_x, trc_y ));
// }
		CountedPtr<PVLine> QtRegionSourceKernel::pvline( RegionCreator *rc, WorldCanvas *wc, double blc_x, double blc_y, double trc_x, double trc_y ) {
			...
			connect( this, SIGNAL( newCorners( double, double, double, double)),
			         result, SLOT( adjustCorners( double, double, double, double)));
			result->releaseSignals( );
			return CountedPtr<PVLine>(result);
		}
		...
		CountedPtr<Polygon> QtRegionSourceKernel::polygon(
			...
			return CountedPtr<Polygon>(result);
			// return CountedPtr<Polygon>( );
		}

		CountedPtr<Polyline> QtRegionSourceKernel::polyline( RegionCreator *rc, WorldCanvas *wc, double x1, double y1 ) {
			...
			return CountedPtr<Polyline>(result);
			// return CountedPtr<Polygon>( );
		}
		...
		CountedPtr<Polyline> QtRegionSourceKernel::polyline(
		    RegionCreator *rc, WorldCanvas *wc, const std::vector<std::pair<double,double> > &pts ) {
		...
		CountedPtr<Rectangle> QtRegionSourceKernel::ellipse( RegionCreator *rc, WorldCanvas *wc, double blc_x, double blc_y, double trc_x, double trc_y ) {
		...
		CountedPtr<Rectangle> QtRegionSourceKernel::point( RegionCreator *rc, WorldCanvas *wc, double x, double y,
