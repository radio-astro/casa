	...
	namespace viewer {
		...
		namespace qt {
			...
			public:
				...
				virtual bool updateStatisticsInfo( CountedPtr<casa::viewer::RegionInfo> ) {
					return false;
				}
			protected:
			...
			public:
				...
				bool updateStatisticsInfo( CountedPtr<casa::viewer::RegionInfo> );
			signals:
		...
		public:
			...
			void updateStatistics( CountedPtr<casa::viewer::RegionInfo> stats, Region* region = NULL );
