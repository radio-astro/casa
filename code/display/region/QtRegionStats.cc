...
namespace casa {
	namespace viewer {
		namespace qt {
			...
			bool SliceStats::updateStatisticsInfo( CountedPtr<casa::viewer::RegionInfo> info ) {
				CountedPtr<SliceRegionInfo> sliceInfo = dynamic_pointer_cast<SliceRegionInfo>(info);
				if ( sliceInfo ) {
			...
			bool pvline_stats_t::updateStatisticsInfo( CountedPtr<casa::viewer::RegionInfo> info ) {
				CountedPtr<PVLineRegionInfo> pvinfo = dynamic_pointer_cast<PVLineRegionInfo>(info);
				if ( pvinfo ) {
		...
		void QtRegionStats::updateStatistics( CountedPtr<casa::viewer::RegionInfo> stats, Region* region ) {
		...
		bool QtRegionStats::updateStatisticsInfo( CountedPtr<casa::viewer::RegionInfo> info ) {
