...
namespace casa {
	...
	namespace viewer {
		...
		public:
			...
			void updateStatistics( std::list<CountedPtr<RegionInfo> > *stats );
			void updateFrameInformation( int count );
			void reloadStatistics( );
			void updateCenters( std::list<CountedPtr<RegionInfo> > *centers );
		...
		private:
			...
			void statisticsUpdate( QtRegionStats *regionStats, CountedPtr<casa::viewer::RegionInfo> regionInfo );
