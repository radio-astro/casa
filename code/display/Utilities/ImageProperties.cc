...
namespace casa {
	namespace viewer {
		...
		ImageProperties::ImageProperties(CountedPtr<ImageInterface<Float> > image ) {
			reset(image);
		}
		ImageProperties::ImageProperties( CountedPtr<ImageInterface<std::complex<float> > > ) {
		...
		void ImageProperties::initialize_state( CountedPtr<ImageInterface<Float> > image ) {
		...
		void ImageProperties::reset(CountedPtr<ImageInterface<Float> > image ) {
			// clear settings...
			clear_state( );
