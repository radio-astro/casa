...
namespace casa {
	...
	int Util::getTabularFrequencyAxisIndex(CountedPtr<const ImageInterface<Float> > img){
		int tabIndex = -1;
	...
	std::pair<Vector<Float>,Vector<Float> > Util::getProfile(CountedPtr<const casa::ImageInterface<Float> > imagePtr,
