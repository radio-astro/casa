...
namespace casa {
	...
	public:
		...
		virtual SpectralCoordinate getSpectralCoordinate(CountedPtr<const ImageInterface<Float> > imagePtr, Bool& validCoord ) = 0;
		...
		virtual CountedPtr<const ImageInterface<Float> > getImage( const QString& imageName = "") const = 0;
		...
		virtual void imageCollapsed(String path, String dataType, String displayType,
				...
				CountedPtr<ImageInterface<Float> > img = CountedPtr<ImageInterface<Float> >())=0;
