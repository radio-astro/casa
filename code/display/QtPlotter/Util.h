...
namespace casa { //# NAMESPACE CASA - BEGIN
	...
	public:
		...
		static int getTabularFrequencyAxisIndex(CountedPtr<const ImageInterface<Float> > img);

		static Record getRegionRecord( String shape, const DisplayCoordinateSystem& cSys,
					const Vector<Double>& x, const Vector<Double>& y);

		static std::pair<Vector<Float>,Vector<Float> > getProfile(CountedPtr<const casa::ImageInterface<Float> > imagePtr,
