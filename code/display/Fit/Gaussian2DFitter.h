...
namespace casa {
	...
	public:
		...
		void setFitParameters( CountedPtr<const ImageInterface<Float> > image, const String& box,
		...
		QList<RegionShape*> toDrawingDisplay( const CountedPtr<const ImageInterface<Float> > image, const QString& colorName) const;
	...
	private:
		...
		CountedPtr<std::pair<Float, Float> > includePixs;
		CountedPtr<std::pair<Float, Float> > excludePixs;
		String pixelBox;
		String filePath;
		int channelNumber;
		String estimateFile;
