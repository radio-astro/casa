...
namespace casa {
	...
	void Gaussian2DFitter::setFitParameters( CountedPtr<const ImageInterface<Float> > image, const String& box,
	...
	QList<RegionShape*> Gaussian2DFitter::toDrawingDisplay(const CountedPtr<const ImageInterface<Float> > image, const QString& colorName) const {
