...
// </todo>
	...
	public:
		...
		// not specified as xAxis, yAxis or mAxis.
		// <group>
		LatticeAsRaster( CountedPtr<ImageInterface<T> > image, const uInt xAxis, const uInt yAxis, const uInt mAxis, const IPosition fixedPos, viewer::StatusSink *sink=0 );
		LatticeAsRaster(CountedPtr<ImageInterface<T> > image, const uInt xAxis,
		                const uInt yAxis);
		// </group>
