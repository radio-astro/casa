...
// >2d image-based ctor
	template <class T>
	LatticeAsRaster<T>::LatticeAsRaster( CountedPtr<ImageInterface<T> > image,const uInt xAxis, const uInt yAxis, const uInt mAxis, const IPosition fixedPos, viewer::StatusSink *sink ) :
...
// 2d image-based ctor
	template <class T>
	LatticeAsRaster<T>::LatticeAsRaster(CountedPtr<ImageInterface<T> > image,
