...
std::auto_ptr<vector<vector<Matrix<Double> > > > ImageProfileFitter::_createPCFMatrices() const {
...
Bool ImageProfileFitter::_setAxisTypes() {
...
void ImageProfileFitter::_marshalFitResults(
