...
void testException(
	const String& test, const std::unique_ptr<ImageInterface<Float> > &image,
...
void testBeam(
	const std::unique_ptr<ImageInterface<Float> > &in,
...
void testNoReorder(
	const std::unique_ptr<ImageInterface<Float> > &image,
...
int main() {
	...
	delete [] parts;
	std::unique_ptr<ImageInterface<Float> > goodInputImage(
