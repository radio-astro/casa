                                                ...
                                                const string & column)
{
    ...
    for (uInt cube = 0; cube != nHypercubes; cube ++){
        ...
        // Compute the appropriate cachesize which will hold at least a single
        ...
        // the baseline axis due to the autocorrelations not occuring near the
