...
// statistics for each casacore::MS chunk provided by a VisibilityIterator2 instance. See
...
public:
	...
	// casacore::StatisticsAlgorithm instance initialized with a data provider for the
