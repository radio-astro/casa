...
Vi2DataDescriptionIdsDataProvider::Vi2DataDescriptionIdsDataProvider(
	...
	: Vi2DataProvider(
		vi2,
		mergedColumns,
		vi::VisBufferComponent2::DataDescriptionIds,
		omit_flagged_data,
		false) {}

const Vector<Int>&
Vi2DataDescriptionIdsDataProvider::dataArray() {
