...
//
#ifndef MSVIS_STATISTICS_VI2_STATS_REAL_ITERATOR_H_
#define MSVIS_STATISTICS_VI2_STATS_REAL_ITERATOR_H_
...
class Vi2StatsRealIterator final
...
#endif // MSVIS_STATISTICS_VI2_STATS_REAL_ITERATOR_H_
