...
//    void writeVisObserved (const Matrix<CStokesVector> & visibilityStokes);
    ...
    virtual void initSigmaSpectrum (const Cube<Float> & sigmaSpectrum);
...
//                                const ROArrayColumn<Complex> & column) const;
    ...
    void setMsCacheSizes (const MeasurementSet & ms,
                          vector<MSMainEnums::PredefinedColumns> columnIds);
    void setMsColumnCacheSizes (const MeasurementSet&, const string &);
