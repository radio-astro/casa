...
C
     ...
     $   CALL A2STOP('LDETID:Invalid magnetic longitude sector.')
C
...
C
     ...
     $     ACCESS='DIRECT',RECL=MALT)
      ELSE
       PRINT *,IOPEN
       CALL A2STOP('WRONG IOPEN IN LRDEOFF')
      ENDIF
C
...
C
     ...
     $     ACCESS='DIRECT',RECL=MOPM1+1)
      ELSE
       PRINT *, IOPEN
       CALL A2STOP('WRONG IOPEN IN LRDOPFC')
      ENDIF
C
...
C
      ...
      ELSE IF(I .EQ. 2) THEN
         ION='O2'
      ELSE
         CALL A2STOP('EDETION:Invalid ion species index.')
      ENDIF
C
      RETURN
      END
...
C
      ...
      ELSE IF(SPEC .EQ. 'O+ ') THEN
         ION='O '
      ELSE
         CALL A2STOP('DETION:Invalid ion species.')
      ENDIF
C
      RETURN
      END
...
C
      ...
      INTEGER I,J,IOPEN
      REAL D(100),DSHFT(100),ALT(MALT),EOF(MALT,MEOF)
C
...
C
     ...
     $     ACCESS='DIRECT',RECL=MALT)
      ELSE
       PRINT *, IOPEN
       CALL A2STOP('WRONG IOPEN IN RDEOFF')
      ENDIF
C
...
C
     ...
     $     ACCESS='DIRECT',RECL=RECLEN)
      ELSE
       PRINT *, IOPEN
       CALL A2STOP('WRONG IOPEN IN RDOPCF')
      ENDIF
C
...
C
      ...
      ELSE
       PRINT *, IOPEN
       CALL A2STOP('WRONG IOPEN IN READAWS')
      ENDIF
C.......................................................................
...
C.......................................................................
  ...
  600 CONTINUE
      ...
      RETURN
  990 CONTINUE
      PRINT *,'URSIDA:  IREC = ',IREC
      PRINT *,'KF: ',KF
      CALL A2STOP('URSI:Bad read from URSI coefficient database.')
      END
C
