...
C
      OMEGA=ASTAR(1)
      DO 5 J=1,LH
         OMEGA=OMEGA+(ASTAR(J+1)*COTIME(J))+(BSTAR(J+1)*SITIME(J))
    5 CONTINUE
C
      RETURN
      END
...
C***********************************************************************
      ...
      REAL U(13,76)
C
      DATA POS(3)/3.E5/,DR/.01745329/,RD/57.2958/
C......................................................................
C     BEGIN EXECUTION                                                 .
C......................................................................
      MX=K(9)+1
...
C......................................................................
      ...
      C(1)=RD*ATAN(ATAN(-UNE(1)/SQRT(TMP))/SQRT(COS(DR*POS(1))))
      C(2)=DLON
      C(3)=POS(1)
C.......................................................................
