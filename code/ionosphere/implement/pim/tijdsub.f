...
C
      INTEGER iyr,idoy, ieq, nday81,nleapd
...
C            range of values for each specific year from 81-99.  This 
...
C            IYR-1980, with 0 as a value for years >1999.  This 
...
C----------------
     ...
     1        6.2d-6*t0**3
      ...
      ieq = iyr - 1980
      IF (ieq .GT. 19) THEN
         WRITE (*,*) 'Update Equation of Equinox DATA in "sidtim.f"'
         ieq = 20
      END IF
