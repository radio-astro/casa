...
public:
  ...
  /** Alternative form of the setter for user zenith water vapor column for forward radiative transfer calculations. The user
   zenith water vapor column equals the retrieved zenith water vapor column from H2O radiometers,
   every time the last one is derived with the retrieveandupdateWaterVapor accessor.*/
  void setUserWH2O(double dwh2o, string units)
  {
  ...
  Temperature getAverageTebbSky(Length wh2o,
                                double skycoupling,
                                Temperature Tspill)
  {
  ...
  Temperature getAverageTebbSky(double skycoupling, Temperature Tspill)
  {
    unsigned int n = 0;
  ...
  Temperature getTebbSky(Length wh2o)
  {
    unsigned int n = 0;
  ...
  /** Accesor to the Equivalent Blackbody Temperature in spectral window 0 and channel nc, for Water
   Vapor Column wh2o, the current Air Mass, and perfect Sky Coupling to the sky */
  Temperature getTebbSky(unsigned int nc, Length wh2o)
  {
    unsigned int n = 0;
  ...
  /** Accesor to the Equivalent Blackbody Temperature in spectral window spwid and channel nc, for Water
   Vapor Column wh2o, the current Air Mass, and perfect Sky Coupling to the sky */
  Temperature getTebbSky(unsigned int spwid, unsigned int nc, Length wh2o)
  {
  ...
  Temperature getTebbSky(unsigned int nc, Length wh2o, double airmass)
  {
    unsigned int n = 0;
  ...
  /** The same setter is available for couples of parameters. The order does not matter  */
  bool
      setBasicAtmosphericParameters(Pressure groundPressure, Humidity humidity);
  /** The same setter is available for couples of parameters. The order does not matter  */
  bool
      setBasicAtmosphericParameters(Humidity humidity, Pressure groundPressure);
  /** The same setter is available for couples of parameters. The order does not matter  */
  bool setBasicAtmosphericParameters(Pressure groundPressure,
                                     double tropoLapseRate);
  /** The same setter is available for couples of parameters. The order does not matter */
  ...
  void addNewSpectralWindow(vector<Frequency> chanFreq)
  {
  ...
  Length WaterVaporRetrieval_fromFTS(vector<double> v_transmission)
  {
  ...
  void setWaterVaporRadiometer(WaterVaporRadiometer waterVaporRadiometer)
  {
  ...
  double getWaterVaporRadiometerSkyCoupling(int n)
  {
    return waterVaporRadiometer_.getSkyCoupling()[n];
  }
  /** Accessor to the sky coupling of channel n of the Water Vapor Radiometer*/
  Percent getWaterVaporRadiometerSignalGain(int n)
  {
  ...
  WaterVaporRadiometer getWaterVaporRadiometer()
  {
  ...
  Temperature getWVRAverageSigmaTskyFit(vector<WVRMeasurement> RadiometerData,
                                        unsigned int n,
                                        unsigned int m);
  Temperature getWVRAverageSigmaTskyFit(vector<WVRMeasurement> RadiometerData,
                                        unsigned int n)
...
protected:
  ...
  bool updateProfilesAndRadiance(Length altitude,
                                 Pressure groundPressure,
                                 Temperature groundTemperature,
                                 double tropoLapseRate,
  ...
  Length mkWaterVaporRetrieval_fromTEBB(unsigned int spwId,
                                        Percent signalGain,
                                        vector<Temperature> v_measuredSkyTEBB,
                                        double airm,
                                        vector<double> spwId_filter,
                                        double skycoupling,
                                        Temperature tspill)
  {
    ...
    return mkWaterVaporRetrieval_fromTEBB(spwIds,
                                          signalGains,
                                          v_measuredSkyTEBBs,
                                          airm,
                                          spwId_filters,
  ...
  Length
      mkWaterVaporRetrieval_fromTEBB(vector<unsigned int> spwId,
                                     vector<Percent> signalGain,
  ...
  WVRMeasurement
      mkWaterVaporRetrieval_fromWVR(vector<Temperature> measuredSkyBrightnessVector,
                                    vector<unsigned int> radiometricChannels,
                                    vector<double> skyCoupling,
                                    vector<Percent> signalGain,
