...
void WorldCanvas::operator()(const PCPositionEvent &pev) {
  ...
  if(kbdEvent) { 
    ...
    switch(key) { 
      case Display::K_Left:    case Display::K_Right:
      case Display::K_Up:      case Display::K_Down: 
      case Display::K_Home:    case Display::K_End:
      case Display::K_Page_Up: case Display::K_Page_Down:
      distrib = inWC(0,0); break;
