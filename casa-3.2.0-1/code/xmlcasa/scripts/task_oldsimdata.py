...
#            model_min,model_max, model_rms = util.statim(modelimage,plot=False,incell=model_cell)
        ...
        if verbose:
            msg("preparing empty measurement set",origin="oldsimdata",priority="warn")
...
#                sh.rmtree(outflat) 
        ...
        msg("task_oldsimdata -- TypeError: %s" % e,priority="error")
        return
    except ValueError, e:
        print "task_oldsimdata -- OptionError: ", e
        return
