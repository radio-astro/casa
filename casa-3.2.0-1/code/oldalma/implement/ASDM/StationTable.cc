...
StationRow* StationTable::newRowCopy(StationRow* row) {
	 ...
	 */
	StationRow*  StationTable::checkAndAdd(StationRow* x) throw (DuplicateKey, UniquenessViolationException) {
...
StationRow* StationTable::lookup(string name, vector<Length > position, StationTypeMod::StationType type) {
...
#ifndef WITHOUT_ACS
	void StationTable::fromIDL(StationTableIDL x) throw(DuplicateKey,ConversionException) {
	...
	char *StationTable::toFITS() const throw(ConversionException) {
		throw ConversionException("Not implemented","Station");
	}

	void StationTable::fromFITS(char *fits) throw(ConversionException) {
		throw ConversionException("Not implemented","Station");
	}

	string StationTable::toVOTable() const throw(ConversionException) {
		throw ConversionException("Not implemented","Station");
	}

	void StationTable::fromVOTable(string vo) throw(ConversionException) {
		throw ConversionException("Not implemented","Station");
	}

	string StationTable::toXML()  throw(ConversionException) {
		string buf;
		buf.append("<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?> ");
//		buf.append("<StationTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:noNamespaceSchemaLocation=\"../../idl/StationTable.xsd\"> ");
	...
	void StationTable::fromXML(string xmlDoc) throw(ConversionException) {
		Parser xml(xmlDoc);
	...
	void StationTable::error() throw(ConversionException) {
