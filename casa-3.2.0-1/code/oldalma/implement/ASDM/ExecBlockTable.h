...
public:
	...
	/**
	  ...
	  * Provided to facilitate the call from Python, otherwise the newRow method will be preferred.
	  */
	 ExecBlockRow *newRowCopy(ExecBlockRow *row); 
	 ...
	 * @param x. A pointer on the row to be added.
 	 * @returns a ExecBlockRow pointer.
	 */	 
...
// In all cases we maintain a private ArrayList of ExecBlockRow s.
