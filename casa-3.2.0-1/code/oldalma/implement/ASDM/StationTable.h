...
public:
	 ...
	 */	
	void fromIDL(StationTableIDL x) throw(DuplicateKey,ConversionException);
#endif
...
private:
	 ...
	 */
	StationRow* checkAndAdd(StationRow* x) throw (DuplicateKey, UniquenessViolationException);
