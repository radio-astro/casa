/*============================================================================
    ...
    $Id: tcel2.c,v 4.3 2007/12/27 05:35:51 cal103 Exp $
*=============================================================================
*
      ...
      for (crval2 = -90; crval2 <=  90; crval2 += crval2_i) {
         for (crval1 = -180; crval1 <= 180; crval1 += 90) {
            ...
            for (lonpole = -180; lonpole <= 180; lonpole += lonpole_i) {
               ...
               sprintf(text, "(CRVAL1, CRVAL2, LONPOLE): (%+3.3d, %+2.2d, "
                  "%+3.3d)", crval1, crval2, lonpole);
               cpgtext(-180.0f, 200.0f, text);

               /* Skip invalid values of LONPOLE. */
               if (celset(&celestial)) {
                  sprintf(text, "INVALID VALUE OF LONPOLE (= %+3.3d)",
                     lonpole);
