...
public:
	...
	/**
	  ...
	  * Provided to facilitate the call from Python, otherwise the newRow method will be preferred.
	  */
	 EphemerisRow *newRowCopy(EphemerisRow *row); 
	 ...
	 * @param x. A pointer on the row to be added.
 	 * @returns a EphemerisRow pointer.
	 */	 
	...
	/**
	 * Get all rows.
	 * @return Alls rows as a vector of pointers of EphemerisRow. The elements of this vector are stored in the order 
	 * in which they have been added to the EphemerisTable.
	 */
	vector<EphemerisRow *> get() ;
	 ...
	 */	
	void fromIDL(EphemerisTableIDL x) throw(DuplicateKey,ConversionException);
#endif
...
private:
	...
	void autoIncrement(string key, EphemerisRow* x);
	 ...
	 */
	EphemerisRow* checkAndAdd(EphemerisRow* x) throw (DuplicateKey, UniquenessViolationException);



// A data structure to store the pointers on the table's rows.

// In all cases we maintain a private ArrayList of EphemerisRow s.
   vector<EphemerisRow * > privateRows;
