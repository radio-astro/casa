...
public:
	 ...
	 */
	  ...
	  * @table the EphemerisTable to which the row built by deserialization will be parented.
	  */
	 static EphemerisRow* fromBin(EndianISStream& eiss, EphemerisTable& table);	 
