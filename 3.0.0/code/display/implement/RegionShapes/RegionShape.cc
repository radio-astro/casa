...
void RegionShapeLabel::setText(const String& text) { m_text = text; }
...
void RegionShapeLabel::setItalic(bool italic) { m_italic = italic; }
void RegionShapeLabel::setBold(bool bold) { m_bold = bold; }
void RegionShapeLabel::setAngle(double angle) { m_angle = angle; }

bool RegionShapeLabel::isEmpty() const { return m_text.empty(); }
const String& RegionShapeLabel::text() const { return m_text; }
const String& RegionShapeLabel::font() const { return m_font; }
int RegionShapeLabel::size() const { return m_pointSize; }
const String& RegionShapeLabel::color() const { return m_color; }
bool RegionShapeLabel::isItalic() const { return m_italic; }
bool RegionShapeLabel::isBold() const { return m_bold; }
double RegionShapeLabel::angle() const { return m_angle; }
...
Display::DisplayDataType RegionShape::classType(){return Display::Annotation;}
...
String RegionShape::lineColor() const { return m_color; }
...
double RegionShape::lineWidth() const { return m_width; }
...
RegionShape::LineStyle RegionShape::lineStyle() const { return m_style; }
...
String RegionShape::text() const { return m_label.text(); }
...
const RegionShapeLabel& RegionShape::label() const { return m_label; }
void RegionShape::setLabel(const RegionShapeLabel& label) {
    m_label = label;
    refresh(true);
}

bool RegionShape::linethrough() const { return m_lt; }
String RegionShape::linethroughColor() const { return m_ltColor; }
double RegionShape::linethroughWidth() const { return m_ltWidth; }
RegionShape::LineStyle RegionShape::linethroughStyle() const{return m_ltStyle;}
...
double RegionShape::xMin() const { return m_xMin; }
double RegionShape::xMax() const { return m_xMax; }
double RegionShape::yMin() const { return m_yMin; }
double RegionShape::yMax() const { return m_yMax; }

double RegionShape::screenXMin() const { return m_screenXMin; }
double RegionShape::screenXMax() const { return m_screenXMax; }
double RegionShape::screenYMin() const { return m_screenYMin; }
double RegionShape::screenYMax() const { return m_screenYMax; }
