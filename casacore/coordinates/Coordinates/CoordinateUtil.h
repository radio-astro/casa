...
// <group>
   static String formatCoordinate(const IPosition& pixel, CoordinateSystem& cSys, Int precision = -1);
   static String formatCoordinate(const Vector<Double>& pixel, CoordinateSystem& cSys, Int precision = -1);
// </group>
