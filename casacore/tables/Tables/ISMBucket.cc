...
//#
//# $Id: ISMBucket.cc 20551 2009-03-25 00:11:33Z Malte.Marquarding $
...
Bool ISMBucket::check (uInt &offendingCol, uInt &offendingIndex, uInt &offendingRow, uInt &offendingPrevRow) const
{
