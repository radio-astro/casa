//# tfitsread_data.cc: FITS test program to read and display values from a FITS file
//# by using the FitsInput::read(FITS::HDUType t, char *addr, int nb) method. 
...
//#
//# $Id: tfitsread_data.cc 21513 2014-11-21 12:33:13Z gervandiepen $
...
cout<< " The header card images are( testing kwlist_str()): " << endl; \
	...
	for( int k = 0; k< imageCards.nelements(); k++ ){  \
