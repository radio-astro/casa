 ...
 * <TD> Tag</TD>
 * <TD> &nbsp; </TD>
 * <TD> &nbsp;refers to a unique row in the Antenna table. </TD>
 * </TR>
 ...
 * <TD> Tag</TD>
 * <TD> &nbsp; </TD>
 * <TD> &nbsp;refers to a unique row in the SpectralWindow table. </TD>
 * </TR>
 ...
 * <TD> int</TD>
 * <TD> &nbsp; </TD>
 * <TD> &nbsp;Refers to the collection of rows in the Feed table having this	 value of feedId in their key. </TD>
 * </TR>
...
public:
	 ...
	 * @throws ConversionException
	 */	
	void fromIDL(SysPowerTableIDL x) ;
#endif
	 ...
	 *
	 */
	 const vector<SysPowerRow *>& get() const ;
	 ...
	 */
	 vector <SysPowerRow*> *getByContext(Tag antennaId, Tag spectralWindowId, int feedId);
...
private:
	 ...
	 *
	 */
	 SysPowerRow * insertByStartTime(SysPowerRow* x, vector<SysPowerRow* >& row);
...
// In all cases we maintain a private vector of SysPowerRow s.
   vector<SysPowerRow * > privateRows;
	...
	typedef vector <SysPowerRow* > TIME_ROWS;
	 ...
	 *
	 */
	void getByKeyNoAutoIncNoTime(vector <SysPowerRow*>& vin, vector <SysPowerRow*>& vout,  Tag antennaId, Tag spectralWindowId, int feedId);
