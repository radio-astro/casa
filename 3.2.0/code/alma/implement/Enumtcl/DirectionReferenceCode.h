...
template<>
 struct enum_set_traits<DirectionReferenceCode> : public enum_set_traiter<DirectionReferenceCode,32,DirectionReferenceCodeMod::MOON> {};

template<>
class enum_map_traits<DirectionReferenceCode,void> : public enum_map_traiter<DirectionReferenceCode,void> {
public:
  static bool   init_;
  ...
  static bool   init(){
    EnumPar<void> ep;
    m_.insert(pair<DirectionReferenceCode,EnumPar<void> >
  ...
  static map<DirectionReferenceCode,EnumPar<void> > m_;
};
