...
class sdsmooth_test(unittest.TestCase):
    ...
    'OrionS_rawACSmod', as follows:
      ...
      default(sdbaseline)
      sdbaseline(sdfile='temp2.asap',iflist=[2],masklist=blchan2,
                 maskmode='list',outfile=self.sdfile)

      The reference stat values can be obtained by
      sdstat(sdfile=outfile,masklist=linechan2)
      sdstat(sdfile=outfile,masklist=basechan2)
    """
    ### TODO:
    ...
    sdfile = 'OrionS_rawACSmod_if2_calTPave_bl.asap'
    ...
    def test01(self):
        ...
        result = sdsmooth(sdfile=sdfile,outfile=outfile)
    ...
    def test02(self):
        ...
        result =sdsmooth(sdfile=sdfile,outfile=outfile,kernel=kernel)
        self.assertEqual(result,None,
                         msg="The task returned '"+str(result)+"' instead of None")
        ### reference values ( ASAP r2084 + CASA r14498)
    ...
    def test06(self):
        ...
        result1 =sdsmooth(sdfile=sdfile,outfile=outfile)
        ...
        result2 =sdsmooth(sdfile=sdfile,outfile=outfile,
